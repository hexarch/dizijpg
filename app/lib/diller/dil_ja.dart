...
const Map<String, String> cevirilerJa = {
  'dizi.jpg uygulamasını indir': 'dizi.jpg アプリをダウンロード',
  'Daha hızlı gezinme, bildirimler ve tam ekran deneyim uygulamada.':
      'より速い操作、通知、全画面体験はアプリで。',
  'Uygulamayı indir': 'アプリをダウンロード',
  'Tarayıcıda devam et': 'ブラウザで続ける',
  'Bir bağlantı yapıştır ya da video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'リンクを貼るか動画をアップロードして、友だちを招待して一緒に見よう。',
  'URL yapıştır': 'リンクを貼り付け',
  'Yapıştır': '貼り付け',
  'Panoda görsel yok': 'クリップボードに画像がありません',
  ...
  '{} ve {} yorumunu beğendi': '{} と {} がコメントにいいねしました',
  '{} ve {} kişi yorumunu beğendi': '{} と他{}人がコメントにいいねしました',
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'ログイン状態の維持と、言語やテーマなどの設定を記憶するためにローカルストレージを使用します。ウェブではサイトのどの部分が使われているかを集計して把握するために Google Analytics が動作し、このツールが独自の測定用 Cookie をブラウザに書き込みます。広告や広告ターゲティングの Cookie はありません。',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'ドラマや映画の情報は TMDB から、配信サービスの情報は JustWatch から取得しています。プッシュ通知は Google Firebase 経由で配信され、ウェブのトラフィックは Google Analytics で測定し、サイトのトラフィックは Cloudflare が保護しています。これらのサービスにはそれぞれのプライバシーポリシーが適用されます。',
  ...
  'Dizi veya film seç (zorunlu)': '作品を選択（必須）',
  'Bölüm seç (isteğe bağlı)': 'エピソードを選択（任意）',
  '{}. sezon {}. bölüm': 'シーズン{} 第{}話',
  'Ne düşünüyorsun?': 'どう思いますか？',
  '{}/{} yükleniyor': '{}/{} をアップロード中',
  'Fotoğraf/video ekle': '写真または動画を追加',
  'Paylaşmak için önce bir dizi veya film seç.': '共有するにはまず作品を選んでください。',
  'Sezon seç': 'シーズンを選択',
  '{}. sezon': 'シーズン{}',
  'Bölüm seçme (yalnız dizi hakkında)': 'エピソードなし（作品全体について）',
  'Sezonlar yüklenemedi.': 'シーズンを読み込めませんでした。',
  'Bu dizide bölüm bilgisi yok.': 'この作品のエピソード情報がありません。',
  'Bu sezonda bölüm yok.': 'このシーズンにエピソードはありません。',
  '{}. bölüm': '第{}話',
  ...
  'Temizle': 'クリア',
  'Oyuncu': '俳優',
  'Böyle bir oda yok': 'そんなルームはありません',
  'Bu oda kapandı': 'このルームは終了しました',
  'Bu odaya girmek için davet ya da oda kodu gerekli': '参加するには招待かルームコードが必要です',
  'Oda dolu': 'ルームが満員です',
  'Bu odaya giremezsin': 'このルームには入れません',
  'Bu odanın üyesi değilsin': 'このルームのメンバーではありません',
  'Bunu yalnız oda sahibi yapabilir': 'これはルームのホストだけができます',
  'Oda sahibi odayı kapatmalı': 'ルームはホストが閉じてください',
  'Zaten açık bir odan var': 'すでに開いているルームがあります',
  'Oda kodu 6 karakter olmalı': 'ルームコードは6文字です',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'ゲストアカウントはルームを開けません。アカウントを作ると開けます。',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      '相互フォローの相手だけ招待できます',
  'Video en fazla {} GB olabilir': '動画は最大 {} GB です',
  'Yalnızca MP4 veya WebM izlenebilir': 'MP4 または WebM のみ再生できます',
  '{} odaya katıldı': '{}さんがルームに参加しました',
  '{} odadan ayrıldı': '{}さんがルームから退出しました',
  '{} bir video yükledi': '{}さんが動画をアップロードしました',
  'bitti': '終了',
  '{} sn': '{}秒',
  'Birlikte izle': '一緒に見る',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      '動画をアップロードして友だちを招待し、同じタイミングで見ましょう。',
  'Henüz bir odan ya da davetin yok.': 'まだルームも招待もありません。',
  'Odaya katıl': 'ルームに参加',
  'Oda kodu': 'ルームコード',
  'Katıl': '参加',
  'Oda oluştur': 'ルームを作る',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'ルームは12時間で自動的に閉じ、動画も削除されます。',
  'Odam': '自分のルーム',
  '@{} odası': '@{}さんのルーム',
  'Seni davet etti': 'あなたを招待しました',
  '{} kişi': '{}人',
  'Video yok': '動画なし',
  '{} kaldı': '残り {}',
  'Davet': '招待',
  '@{} davet edildi': '@{}さんを招待しました',
  'Oda kodu kopyalandı': 'ルームコードをコピーしました',
  'Odayı kapat': 'ルームを閉じる',
  'Odadan ayrıl': 'ルームから退出',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'ルームが閉じられ、動画も削除されます。元に戻せません。',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'ルームから退出します。コードか招待で戻れます。',
  'Ayrıl': '退出',
  'İzleme odası': 'ウォッチルーム',
  'Odalar 12 saat sonra kendiliğinden kapanır.': 'ルームは12時間で自動的に閉じます。',
  '{} kişi · {} kaldı': '{}人 · 残り {}',
  'Davet et': '招待',
  'Bir video yükle, izlemeye başlayın': '動画をアップロードして見始めましょう',
  'Oda sahibi henüz video yüklemedi': 'ホストはまだ動画をアップロードしていません',
  'Video yükle': '動画をアップロード',
  'En fazla {} GB · MP4 veya WebM': '最大 {} GB · MP4 または WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'アップロードを再開 · {}/{} MB',
  'Yükleniyor · {}/{} MB': 'アップロード中 · {}/{} MB',
  'Videoyu değiştir': '動画を変更',
  'Oda sahibiyle eşleniyor': 'ホストと同期しています',
  'Sohbet boş': 'チャットは空です',
  'İzlerken buradan konuşabilirsiniz.': '見ながらここで話せます。',
  'oda sahibi': 'ホスト',
  'davet bekliyor': '招待を送信済み',
  'çevrimdışı': 'オフライン',
  'Mesaj yaz...': 'メッセージを書く...',
  'Oda kodunu kopyala': 'ルームコードをコピー',
  'Oda kodu {} — kopyala': 'ルームコード {} — コピー',
  'Arkadaşını davet et': '友だちを招待',
  'kullanıcı adı': 'ユーザー名',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      '相互フォローの相手だけ招待できます。',
  ...
  'Değerlendirme': '評価',
  'Değerlendirmeler ({})': '評価 ({})',
  'Henüz değerlendirme yok': 'まだ評価がありません',
  'Puan verilen dizi ve filmler burada listelenir.': '評価した番組や映画がここに表示されます。',
  'Değerlendirmeler yüklenemedi': '評価を読み込めませんでした',
  'Ayarla': '調整',
  'Filtre': 'フィルター',
  'Çıkartma': 'ステッカー',
  'Parlaklık': '明るさ',
  ...
  'Ekran görüntüsü aldın': 'スクリーンショットを撮影しました',
  '{} ekran görüntüsü aldı': '{} がスクリーンショットを撮影しました',
  'Gönderiliyor': '送信中',
  'İzlediğin her şeyi tek yerde takip et': '観たものをすべてひとつの場所で記録',
  'Keşfet\'e göz at': '「発見」を見る',
  'Giriş yap': 'ログイン',
  'Neler yapabilirsin?': 'できること',
  'Bölüm bölüm takip': 'エピソードごとの記録',
  'Kaldığın yeri asla kaybetme: sezonları ve bölümleri tek dokunuşla işaretle, ilerlemeni gör.':
      'どこまで観たか忘れない：シーズンとエピソードをワンタップでチェックして進捗を確認。',
  'Yeni bölümler ve vizyon tarihleri takviminde; hiçbir bölümü kaçırma.':
      '新しいエピソードや公開日をカレンダーで管理；見逃しゼロ。',
  'Puanla ve yorumla': '評価とレビュー',
  'Ondalıklı puan ver, yorum yaz; IMDb, Rotten Tomatoes ve Metacritic puanlarını yan yana gör.':
      '小数点評価とレビュー投稿；IMDb、Rotten Tomatoes、Metacriticのスコアを並べて確認。',
  'Kendi listelerin': '自分だけのリスト',
  'Listeler oluştur, sırala ve paylaş; izleme listen her cihazında seninle.':
      'リストを作成・並べ替え・共有；ウォッチリストはどの端末でも一緒。',
  'Arkadaşlarınla': '友だちと',
  'Akışta arkadaşlarının ne izlediğini gör, yorumlarına tepki ver, mesajlaş.':
      'フィードで友だちが観ているものを見て、レビューにリアクションし、メッセージを送ろう。',
  'İzleme odasında aynı anda izleyin ve sohbet edin.': 'ウォッチルームで同時に観ながらチャット。',
  'Yapım verileri: TMDB': '作品データ：TMDB',
  'Galeriye kaydet': 'ギャラリーに保存',
  'Galeriye kaydedildi': 'ギャラリーに保存しました',
  'Galeriye kaydediliyor...': 'ギャラリーに保存中...',
  'Galeri izni verilmedi': 'ギャラリーの許可がありません',
  'Kaydedilemedi': '保存できませんでした',
  '{} medyayı galeriye kaydet': '{} 件をギャラリーに保存',
  '{}/{} kaydedildi': '{}/{} 件を保存しました',
  'Hemen kaydol': '今すぐ登録',
  ...
  'Alıcı bir kez görebilir': '相手は一度だけ見られます',
  'Açıldı': '開封済み',
  'Flaş': 'フラッシュ',
  'Fotoğraf çekilemedi': '写真を撮影できませんでした',
  'Galeri izni gerekli': 'ギャラリーへのアクセスが必要です',
  'Galeride medya yok': 'ギャラリーにメディアがありません',
  'Galeriden seç': 'ギャラリーから選ぶ',
  'Görmek için dokun': 'タップして表示',
  'Konum': '位置情報',
  'Konum alınamadı': '位置情報を取得できませんでした',
  'Konum izni gerekli': '位置情報の許可が必要です',
  'Konum servisi kapalı': '位置情報サービスがオフです',
  'Konumum': '現在地',
  'Mesaj ekle...': 'メッセージを追加...',
  'Son fotoğrafların burada görünsün diye galerine erişim gerekir.':
      '最近の写真をここに表示するにはギャラリーへのアクセスが必要です。',
  'Tek kullanımlık': '一度だけ表示',
  'Tek kullanımlık fotoğraf': '一度だけ表示の写真',
  'Tek kullanımlık medya': '一度だけ表示のメディア',
  'Tek kullanımlık video': '一度だけ表示の動画',
  'Tek kullanımlık yalnız tek fotoğraf veya videoda': '一度だけ表示は写真または動画1件のみで使えます',
  'Video kaydedilemedi': '動画を保存できませんでした',
  'Video kaydı başlamadı': '動画の録画が開始されませんでした',
  'Çek': '撮影',
  ...
  'Bu mesaj silindi': 'このメッセージは削除されました',
  'Benden sil': '自分側で削除',
  'Herkesten sil': '全員側で削除',
  'Sohbeti sil': 'チャットを削除',
  'Karşı taraftan da sil': '相手側でも削除',
  'Yalnız senden silinir': '自分側のみ削除されます',
  '{} için de silinir': '{} 側でも削除されます',
  'Bu sohbet senden silinecek. Geri alınamaz.': 'このチャットは自分側で削除されます。元に戻せません。',
  'Bu sohbet iki taraftan da silinecek. Geri alınamaz.':
      'このチャットは双方で削除されます。元に戻せません。',
  'Sohbet silinemedi': 'チャットを削除できませんでした',
  'İndiriliyor': 'ダウンロード中',
  'İndirildi': 'ダウンロード済み',
