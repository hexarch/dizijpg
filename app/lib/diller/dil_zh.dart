...
const Map<String, String> cevirilerZh = {
  ...
  'Alıcı bir kez görebilir': '对方只能查看一次',
  'Açıldı': '已打开',
  'Flaş': '闪光灯',
  'Fotoğraf çekilemedi': '无法拍照',
  'Galeri izni gerekli': '需要相册权限',
  'Galeride medya yok': '相册中没有媒体',
  'Galeriden seç': '从相册选择',
  'Görmek için dokun': '点按查看',
  'Konum': '位置',
  'Konum alınamadı': '无法获取位置',
  'Konum izni gerekli': '需要位置权限',
  'Konum servisi kapalı': '位置服务已关闭',
  'Konumum': '我的位置',
  'Mesaj ekle...': '添加消息...',
  'Son fotoğrafların burada görünsün diye galerine erişim gerekir.':
      '要在此显示最近的照片，需要相册权限。',
  'Tek kullanımlık': '阅后即焚',
  'Tek kullanımlık fotoğraf': '阅后即焚照片',
  'Tek kullanımlık medya': '阅后即焚媒体',
  'Tek kullanımlık video': '阅后即焚视频',
  'Tek kullanımlık yalnız tek fotoğraf veya videoda': '阅后即焚仅支持单张照片或视频',
  'Video kaydedilemedi': '无法保存视频',
  'Video kaydı başlamadı': '视频录制未开始',
  'Çek': '拍摄',
  ...
  'Bu mesaj silindi': '此消息已被删除',
  'Benden sil': '仅对我删除',
  'Herkesten sil': '对所有人删除',
  'Sohbeti sil': '删除聊天',
  'Karşı taraftan da sil': '同时对对方删除',
  'Yalnız senden silinir': '仅在你这边删除',
  '{} için de silinir': '也会在 {} 那边删除',
  'Bu sohbet senden silinecek. Geri alınamaz.': '此聊天将在你这边删除，无法撤销。',
  'Bu sohbet iki taraftan da silinecek. Geri alınamaz.': '此聊天将在双方删除，无法撤销。',
  'Sohbet silinemedi': '无法删除聊天',
  'İndiriliyor': '正在下载',
  'İndirildi': '已下载',
