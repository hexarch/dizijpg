...
const Map<String, String> cevirilerVi = {
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'Chúng tôi dùng bộ nhớ cục bộ để giữ bạn đăng nhập và ghi nhớ các tùy chọn như ngôn ngữ và giao diện. Trên web, Google Analytics hoạt động để chúng tôi thấy ở dạng tổng hợp những phần nào của trang được sử dụng; công cụ này ghi cookie đo lường riêng của nó vào trình duyệt của bạn. Không có cookie quảng cáo hay cookie nhắm mục tiêu quảng cáo.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'Thông tin phim và phim truyền hình đến từ TMDB, còn thông tin nhà cung cấp phát trực tuyến đến từ JustWatch. Thông báo đẩy được gửi qua Google Firebase, lưu lượng web được đo bằng Google Analytics và lưu lượng của trang được Cloudflare bảo vệ. Các dịch vụ này tuân theo chính sách bảo mật riêng của họ.',
  ...
  'Yıldız sistemi': 'Hệ thống sao',
  '{} yıldız üzerinden': 'Trên {} sao',
  'Önizleme': 'Xem trước',
  'dokununca açılır': 'chạm để mở',
  'Bir azalt': 'Giảm một',
  'Bir artır': 'Tăng một',
  ...
  'Dizi veya film seç (zorunlu)': 'Chọn phim bộ hoặc phim lẻ (bắt buộc)',
  'Bölüm seç (isteğe bağlı)': 'Chọn tập (tuỳ chọn)',
  '{}. sezon {}. bölüm': 'Mùa {}, tập {}',
  ...
  'Sezonlar yüklenemedi.': 'Không tải được danh sách mùa.',
  'Bu dizide bölüm bilgisi yok.': 'Không có thông tin tập cho phim bộ này.',
  ...
  'Temizle': 'Xóa',
  'Oyuncu': 'Diễn viên',
  'Böyle bir oda yok': 'Không có phòng nào như vậy',
  'Bu oda kapandı': 'Phòng này đã đóng',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'Cần lời mời hoặc mã phòng để vào',
  'Oda dolu': 'Phòng đã đầy',
  'Bu odaya giremezsin': 'Bạn không vào được phòng này',
  'Bu odanın üyesi değilsin': 'Bạn không phải thành viên của phòng này',
  'Bunu yalnız oda sahibi yapabilir': 'Chỉ chủ phòng mới làm được việc này',
  'Oda sahibi odayı kapatmalı': 'Chủ phòng phải là người đóng phòng',
  'Zaten açık bir odan var': 'Bạn đã có một phòng đang mở',
  'Oda kodu 6 karakter olmalı': 'Mã phòng phải có 6 ký tự',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'Tài khoản khách không mở được phòng. Tạo tài khoản để mở phòng.',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'Bạn chỉ mời được những người theo dõi lại bạn',
  'Video en fazla {} GB olabilir': 'Video tối đa {} GB',
  'Yalnızca MP4 veya WebM izlenebilir': 'Chỉ phát được MP4 hoặc WebM',
  '{} odaya katıldı': '{} đã vào phòng',
  '{} odadan ayrıldı': '{} đã rời phòng',
  '{} bir video yükledi': '{} đã tải lên một video',
  'bitti': 'đã hết',
  '{} sn': '{} giây',
  'Birlikte izle': 'Xem cùng nhau',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Tải lên một video, mời bạn bè và cùng xem một lúc.',
  'Henüz bir odan ya da davetin yok.': 'Bạn chưa có phòng hay lời mời nào.',
  'Odaya katıl': 'Vào phòng',
  'Oda kodu': 'Mã phòng',
  'Katıl': 'Tham gia',
  'Oda oluştur': 'Tạo phòng',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'Phòng tự đóng sau 12 giờ và video sẽ bị xóa.',
  'Odam': 'Phòng của tôi',
  '@{} odası': 'Phòng của @{}',
  'Seni davet etti': 'Đã mời bạn',
  '{} kişi': '{} người',
  'Video yok': 'Chưa có video',
  '{} kaldı': 'Còn {}',
  'Davet': 'Lời mời',
  '@{} davet edildi': 'Đã mời @{}',
  'Oda kodu kopyalandı': 'Đã sao chép mã phòng',
  'Odayı kapat': 'Đóng phòng',
  'Odadan ayrıl': 'Rời phòng',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'Phòng sẽ đóng và video sẽ bị xóa. Không thể hoàn tác.',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'Bạn sẽ rời phòng. Có thể quay lại bằng mã hoặc lời mời.',
  'Ayrıl': 'Rời',
  'İzleme odası': 'Phòng xem chung',
  'Odalar 12 saat sonra kendiliğinden kapanır.': 'Phòng tự đóng sau 12 giờ.',
  '{} kişi · {} kaldı': '{} người · còn {}',
  'Davet et': 'Mời',
  'Bir video yükle, izlemeye başlayın': 'Tải lên một video và bắt đầu xem',
  'Oda sahibi henüz video yüklemedi': 'Chủ phòng chưa tải video lên',
  'Video yükle': 'Tải video lên',
  'En fazla {} GB · MP4 veya WebM': 'Tối đa {} GB · MP4 hoặc WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'Đang tiếp tục tải lên · {}/{} MB',
  'Yükleniyor · {}/{} MB': 'Đang tải lên · {}/{} MB',
  'Videoyu değiştir': 'Đổi video',
  'Oda sahibiyle eşleniyor': 'Đang đồng bộ với chủ phòng',
  'Sohbet boş': 'Trò chuyện đang trống',
  'İzlerken buradan konuşabilirsiniz.': 'Vừa xem vừa trò chuyện ở đây.',
  'oda sahibi': 'chủ phòng',
  'davet bekliyor': 'chờ nhận lời mời',
  'çevrimdışı': 'ngoại tuyến',
  'Mesaj yaz...': 'Viết tin nhắn...',
  'Oda kodunu kopyala': 'Sao chép mã phòng',
  'Oda kodu {} — kopyala': 'Mã phòng {} — sao chép',
  'Arkadaşını davet et': 'Mời một người bạn',
  'kullanıcı adı': 'tên người dùng',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'Bạn chỉ mời được những người theo dõi lại bạn.',
  ...
  'Çıkartma': 'Nhãn dán',
  'Parlaklık': 'Độ sáng',
  'Kontrast': 'Độ tương phản',
  'Doygunluk': 'Độ bão hòa',
  'Pozlama': 'Phơi sáng',
  'Sıcaklık': 'Nhiệt độ',
  'Renk tonu': 'Sắc độ',
  'Ton': 'Tông màu',
  ...
  'Alıcı bir kez görebilir': 'Người nhận chỉ xem được một lần',
  'Açıldı': 'Đã mở',
  'Flaş': 'Đèn flash',
  'Fotoğraf çekilemedi': 'Không chụp được ảnh',
  'Galeri izni gerekli': 'Cần quyền truy cập thư viện',
  'Galeride medya yok': 'Thư viện không có ảnh/video',
  'Galeriden seç': 'Chọn từ thư viện',
  'Görmek için dokun': 'Chạm để xem',
  'Konum': 'Vị trí',
  'Konum alınamadı': 'Không lấy được vị trí',
  'Konum izni gerekli': 'Cần quyền vị trí',
  'Konum servisi kapalı': 'Dịch vụ vị trí đang tắt',
  'Konumum': 'Vị trí của tôi',
  'Mesaj ekle...': 'Thêm tin nhắn...',
  'Son fotoğrafların burada görünsün diye galerine erişim gerekir.':
      'Cần quyền truy cập thư viện để hiển thị ảnh gần đây tại đây.',
  'Tek kullanımlık': 'Xem một lần',
  'Tek kullanımlık fotoğraf': 'Ảnh xem một lần',
  'Tek kullanımlık medya': 'Nội dung xem một lần',
  'Tek kullanımlık video': 'Video xem một lần',
  'Tek kullanımlık yalnız tek fotoğraf veya videoda':
      'Xem một lần chỉ dùng được với một ảnh hoặc video',
  'Video kaydedilemedi': 'Không lưu được video',
  'Video kaydı başlamadı': 'Chưa bắt đầu quay video',
  'Çek': 'Chụp',
