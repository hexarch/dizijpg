...
const Map<String, String> cevirilerFi = {
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'Käytämme paikallista tallennustilaa pitääksemme sinut kirjautuneena ja muistaaksemme asetukset, kuten kielen ja teeman. Verkossa on käytössä Google Analytics, jotta näemme koostetusti, mitä sivuston osia käytetään; työkalu kirjoittaa selaimeesi oman mittausevästeen. Mainos- tai kohdennusevästeitä ei ole.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'Sarja- ja elokuvatiedot tulevat TMDB:stä ja suoratoistopalveluiden tiedot JustWatchista. Push-ilmoitukset toimitetaan Google Firebasen kautta, verkkoliikennettä mitataan Google Analyticsilla ja sivuston liikennettä suojaa Cloudflare. Näihin palveluihin sovelletaan niiden omia tietosuojakäytäntöjä.',
  ...
  'Temizle': 'Tyhjennä',
  'Oyuncu': 'Näyttelijä',
  'Böyle bir oda yok': 'Tällaista huonetta ei ole',
  'Bu oda kapandı': 'Tämä huone on suljettu',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'Tarvitset kutsun tai huonekoodin',
  'Oda dolu': 'Huone on täynnä',
  'Bu odaya giremezsin': 'Et voi liittyä tähän huoneeseen',
  'Bu odanın üyesi değilsin': 'Et ole tämän huoneen jäsen',
  'Bunu yalnız oda sahibi yapabilir': 'Vain huoneen isäntä voi tehdä sen',
  'Oda sahibi odayı kapatmalı': 'Isännän on suljettava huone',
  'Zaten açık bir odan var': 'Sinulla on jo avoin huone',
  'Oda kodu 6 karakter olmalı': 'Huonekoodissa on oltava 6 merkkiä',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'Vierastilit eivät voi avata katseluhuoneita. Luo tili, niin voit avata sellaisen.',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'Voit kutsua vain heitä, jotka seuraavat sinua takaisin',
  'Video en fazla {} GB olabilir': 'Video voi olla enintään {} Gt',
  'Yalnızca MP4 veya WebM izlenebilir': 'Vain MP4 tai WebM toistuu',
  '{} odaya katıldı': '{} liittyi huoneeseen',
  '{} odadan ayrıldı': '{} poistui huoneesta',
  '{} bir video yükledi': '{} latasi videon',
  'bitti': 'ohi',
  '{} sn': '{} s',
  'Birlikte izle': 'Katsokaa yhdessä',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Lataa video, kutsu kaverisi ja katsokaa samaan aikaan.',
  'Henüz bir odan ya da davetin yok.':
      'Sinulla ei ole vielä huonetta eikä kutsua.',
  'Odaya katıl': 'Liity huoneeseen',
  'Oda kodu': 'Huonekoodi',
  'Katıl': 'Liity',
  'Oda oluştur': 'Luo huone',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'Huoneet sulkeutuvat itsestään 12 tunnin kuluttua ja video poistetaan.',
  'Odam': 'Oma huoneeni',
  '@{} odası': 'Käyttäjän @{} huone',
  'Seni davet etti': 'Kutsui sinut',
  '{} kişi': '{} henkilöä',
  'Video yok': 'Ei videota',
  '{} kaldı': '{} jäljellä',
  'Davet': 'Kutsu',
  '@{} davet edildi': '@{} kutsuttu',
  'Oda kodu kopyalandı': 'Huonekoodi kopioitu',
  'Odayı kapat': 'Sulje huone',
  'Odadan ayrıl': 'Poistu huoneesta',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'Huone suljetaan ja video poistetaan. Tätä ei voi perua.',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'Poistut huoneesta. Voit palata koodilla tai kutsulla.',
  'Ayrıl': 'Poistu',
  'İzleme odası': 'Katseluhuone',
  'Odalar 12 saat sonra kendiliğinden kapanır.':
      'Huoneet sulkeutuvat itsestään 12 tunnin kuluttua.',
  '{} kişi · {} kaldı': '{} henkilöä · {} jäljellä',
  'Davet et': 'Kutsu',
  'Bir video yükle, izlemeye başlayın': 'Lataa video ja aloittakaa katselu',
  'Oda sahibi henüz video yüklemedi': 'Isäntä ei ole vielä ladannut videota',
  'Video yükle': 'Lataa video',
  'En fazla {} GB · MP4 veya WebM': 'Enintään {} Gt · MP4 tai WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'Jatketaan latausta · {}/{} Mt',
  'Yükleniyor · {}/{} MB': 'Ladataan · {}/{} Mt',
  'Videoyu değiştir': 'Vaihda video',
  'Oda sahibiyle eşleniyor': 'Synkronoidaan isännän kanssa',
  'Sohbet boş': 'Keskustelu on tyhjä',
  'İzlerken buradan konuşabilirsiniz.': 'Täällä voitte jutella katsellessanne.',
  'oda sahibi': 'isäntä',
  'davet bekliyor': 'kutsu odottaa',
  'çevrimdışı': 'offline',
  'Mesaj yaz...': 'Kirjoita viesti...',
  'Oda kodunu kopyala': 'Kopioi huonekoodi',
  'Oda kodu {} — kopyala': 'Huonekoodi {} — kopioi',
  'Arkadaşını davet et': 'Kutsu kaveri',
  'kullanıcı adı': 'käyttäjänimi',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'Voit kutsua vain heitä, jotka seuraavat sinua takaisin.',
  ...
  'Parlaklık': 'Kirkkaus',
  'Kontrast': 'Kontrasti',
  'Doygunluk': 'Kylläisyys',
  'Pozlama': 'Valotus',
  'Sıcaklık': 'Lämpötila',
  'Renk tonu': 'Sävy',
  'Ton': 'Värisävy',
  'Soluk': 'Haalistus',
  'Orijinal': 'Alkuperäinen',
  'Sıcak': 'Lämmin',
  'Soğuk': 'Kylmä',
  'Sinematik': 'Elokuvamainen',
  'Retro': 'Retro',
  'Vintage': 'Vintage',
  'Siyah Beyaz': 'Mustavalkoinen',
  'Canlı': 'Eloisa',
  'Analog': 'Analoginen',
  'Kes': 'Leikkaa',
  'Hız': 'Nopeus',
