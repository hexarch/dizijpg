...
const Map<String, String> cevirilerNl = {
  'dizi.jpg uygulamasını indir': 'dizi.jpg-app downloaden',
  'Daha hızlı gezinme, bildirimler ve tam ekran deneyim uygulamada.':
      'Sneller browsen, meldingen en volledig scherm vind je in de app.',
  'Uygulamayı indir': 'App downloaden',
  'Tarayıcıda devam et': 'Doorgaan in browser',
  ...
  "Tüm verini (izleme, puan, yorum, liste) TV Time uyumlu ZIP olarak al ya da TV Time / Letterboxd ZIP'ini içe aktar.":
      'Exporteer al je gegevens (kijkgeschiedenis, beoordelingen, reacties, lijsten) als TV Time-compatibele ZIP of importeer een ZIP van TV Time / Letterboxd.',
  ...
  '• {} kitaplık kaydı': '• {} bibliotheekitems',
  '• {} favori': '• {} favorieten',
  ...
  '{} ve {} yorumunu beğendi': '{} en {} vonden je reactie leuk',
  '{} ve {} kişi yorumunu beğendi': '{} en {} anderen vonden je reactie leuk',
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'We gebruiken lokale opslag om je ingelogd te houden en voorkeuren zoals taal en thema te onthouden. Op het web draait Google Analytics zodat we geaggregeerd kunnen zien welke onderdelen van de site worden gebruikt; deze tool plaatst een eigen meetcookie in je browser. Er zijn geen advertentie- of targetingcookies.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'Informatie over series en films komt van TMDB en informatie over streamingaanbieders van JustWatch. Pushmeldingen worden bezorgd via Google Firebase, het webverkeer wordt gemeten met Google Analytics en het siteverkeer wordt beschermd door Cloudflare. Deze diensten vallen onder hun eigen privacybeleid.',
  ...
  'Apple ile devam et': 'Doorgaan met Apple',
  'Apple girişi başarısız': 'Inloggen met Apple mislukt',
  ...
  'dizi.jpg için en az 13 yaşında olmalısın.':
      'Je moet minstens 13 jaar oud zijn om dizi.jpg te gebruiken.',
  'En az 13 yaşında olmalısın': 'Je moet minstens 13 jaar oud zijn',
  ...
  'Dizi veya film seç (zorunlu)': 'Kies een serie of film (verplicht)',
  'Bölüm seç (isteğe bağlı)': 'Kies een aflevering (optioneel)',
  '{}. sezon {}. bölüm': 'Seizoen {}, aflevering {}',
  ...
  'E-posta adresini değiştir': 'Je e-mailadres wijzigen',
  'E-posta bağlı değil': 'Geen e-mail gekoppeld',
  'Geçerli bir e-posta adresi yaz': 'Vul een geldig e-mailadres in',
  'Bu zaten hesabının e-posta adresi':
      'Dat is al het e-mailadres van je account',
  'Kod gönder': 'Code versturen',
  'E-posta adresin güncellendi': 'Je e-mailadres is bijgewerkt',
  'Bu e-posta başka bir hesapta kayıtlı':
      'Dit e-mailadres is bij een ander account geregistreerd',
  'Doğrulama kodu YENİ adrese gönderilir; adres ancak kodu girdikten sonra değişir. Şifre sıfırlama ve iki adımlı giriş kodları bundan sonra yeni adrese gider.':
      'De verificatiecode gaat naar het NIEUWE adres; het adres verandert pas nadat je de code invoert. Codes voor wachtwoordherstel en tweestapsaanmelding gaan daarna naar het nieuwe adres.',
  ...
  'Apple ile doğrula': 'Verifiëren met Apple',
  'Hesabını Google ya da Apple ile açtıysan şifren yoktur; kimliğini o hesapla doğrula.':
      'Als je je account met Google of Apple hebt aangemaakt, heb je geen wachtwoord; verifieer je identiteit met dat account.',
  ...
  'Bu liste gizli': 'Deze lijst is privé',
  'Bu kullanıcı izleme listelerini gizli tutmayı tercih ediyor.':
      'Deze gebruiker houdt zijn kijklijsten liever privé.',
  'Bu listede henüz içerik yok': 'Nog geen titels in deze lijst',
  'Otomatik çeviri': 'Automatische vertaling',
  'Otomatik çeviri açıldı': 'Automatische vertaling ingeschakeld',
  'Otomatik çeviri kapatıldı': 'Automatische vertaling uitgeschakeld',
  'Sohbet sessize alındı': 'Chat gedempt',
  'Sessize alma kaldırıldı': 'Dempen opgeheven',
  'Tema özelleştir': 'Thema aanpassen',
  'Sohbette ara': 'Zoeken in chat',
  'Mesajlarda ara...': 'Zoeken in berichten...',
  'Sonuç yok': 'Geen resultaten',
  'Profili gör': 'Profiel bekijken',
  'Medya ve dosyalar': 'Media en bestanden',
  'Henüz medya yok': 'Nog geen media',
  'Varsayılan': 'Standaard',
  'Mor': 'Paars',
  'Pembe': 'Roze',
  'Turuncu': 'Oranje',
  ...
  'Temizle': 'Wissen',
  'Oyuncu': 'Acteur',
  'Böyle bir oda yok': "Zo'n kamer bestaat niet",
  'Bu oda kapandı': 'Deze kamer is gesloten',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'Je hebt een uitnodiging of kamercode nodig',
  'Oda dolu': 'De kamer zit vol',
  'Bu odaya giremezsin': 'Je kunt deze kamer niet binnen',
  'Bu odanın üyesi değilsin': 'Je bent geen lid van deze kamer',
  'Bunu yalnız oda sahibi yapabilir': 'Alleen de host van de kamer kan dat',
  'Oda sahibi odayı kapatmalı': 'De host moet de kamer sluiten',
  'Zaten açık bir odan var': 'Je hebt al een open kamer',
  'Oda kodu 6 karakter olmalı': 'De kamercode moet 6 tekens zijn',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'Gastaccounts kunnen geen kijkkamer openen. Maak een account om er een te openen.',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'Je kunt alleen mensen uitnodigen die je terugvolgen',
  'Video en fazla {} GB olabilir': 'De video mag maximaal {} GB zijn',
  'Yalnızca MP4 veya WebM izlenebilir':
      'Alleen MP4 of WebM kan worden afgespeeld',
  '{} odaya katıldı': '{} is de kamer binnengekomen',
  '{} odadan ayrıldı': '{} heeft de kamer verlaten',
  '{} bir video yükledi': '{} heeft een video geüpload',
  'bitti': 'voorbij',
  '{} sn': '{} s',
  'Birlikte izle': 'Samen kijken',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Upload een video, nodig je vrienden uit en kijk tegelijk.',
  'Henüz bir odan ya da davetin yok.': 'Je hebt nog geen kamer of uitnodiging.',
  'Odaya katıl': 'Kamer binnengaan',
  'Oda kodu': 'Kamercode',
  'Katıl': 'Meedoen',
  'Oda oluştur': 'Kamer maken',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'Kamers sluiten na 12 uur vanzelf en de video wordt verwijderd.',
  'Odam': 'Mijn kamer',
  '@{} odası': 'Kamer van @{}',
  'Seni davet etti': 'Heeft je uitgenodigd',
  '{} kişi': '{} mensen',
  'Video yok': 'Geen video',
  '{} kaldı': 'Nog {}',
  'Davet': 'Uitnodiging',
  '@{} davet edildi': '@{} uitgenodigd',
  'Oda kodu kopyalandı': 'Kamercode gekopieerd',
  'Odayı kapat': 'Kamer sluiten',
  'Odadan ayrıl': 'Kamer verlaten',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'De kamer wordt gesloten en de video verwijderd. Dit kan niet ongedaan worden gemaakt.',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'Je verlaat de kamer. Met de code of een uitnodiging kun je terugkomen.',
  'Ayrıl': 'Verlaten',
  'İzleme odası': 'Kijkkamer',
  'Odalar 12 saat sonra kendiliğinden kapanır.':
      'Kamers sluiten na 12 uur vanzelf.',
  '{} kişi · {} kaldı': '{} mensen · nog {}',
  'Davet et': 'Uitnodigen',
  'Bir video yükle, izlemeye başlayın': 'Upload een video en begin met kijken',
  'Oda sahibi henüz video yüklemedi': 'De host heeft nog geen video geüpload',
  'Video yükle': 'Video uploaden',
  'En fazla {} GB · MP4 veya WebM': 'Tot {} GB · MP4 of WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'Upload wordt hervat · {}/{} MB',
  'Yükleniyor · {}/{} MB': 'Uploaden · {}/{} MB',
  'Videoyu değiştir': 'Video wisselen',
  'Oda sahibiyle eşleniyor': 'Synchroniseren met de host',
  'Sohbet boş': 'De chat is leeg',
  'İzlerken buradan konuşabilirsiniz.': 'Hier kun je praten terwijl je kijkt.',
  'oda sahibi': 'host',
  'davet bekliyor': 'uitnodiging open',
  'çevrimdışı': 'offline',
  'Mesaj yaz...': 'Schrijf een bericht...',
  'Oda kodunu kopyala': 'Kamercode kopiëren',
  'Oda kodu {} — kopyala': 'Kamercode {} — kopiëren',
  'Arkadaşını davet et': 'Nodig een vriend uit',
  'kullanıcı adı': 'gebruikersnaam',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'Je kunt alleen mensen uitnodigen die je terugvolgen.',
  ...
  'Temalar': 'Thema\'s',
  'Renkler': 'Kleuren',
  'Sık kullanılanlar': 'Vaak gebruikt',
  'Klavye': 'Toetsenbord',
  'Kullanıcı adını seç': 'Kies je gebruikersnaam',
  'Google ile giriş yaptığın için adını biz türettik. Profil bağlantın ve etiketlenmelerin bu adla görünür; şimdi kendin seç.':
      'Omdat je met Google bent ingelogd, hebben we een naam voor je gemaakt. Je profiellink en vermeldingen gebruiken die naam; kies nu je eigen naam.',
  'Kontrol ediliyor...': 'Controleren...',
  '@{} müsait': '@{} is beschikbaar',
  'Bu adı seç': 'Deze naam gebruiken',
  ...
  'Filtre': 'Filter',
  'Çıkartma': 'Sticker',
  'Parlaklık': 'Helderheid',
  'Kontrast': 'Contrast',
  'Doygunluk': 'Verzadiging',
  'Pozlama': 'Belichting',
  'Sıcaklık': 'Temperatuur',
  'Renk tonu': 'Tint',
  'Ton': 'Kleurzweem',
  'Soluk': 'Vervagen',
  'Orijinal': 'Origineel',
  'Sıcak': 'Warm',
  'Soğuk': 'Koel',
  'Sinematik': 'Cinematisch',
  'Retro': 'Retro',
  'Vintage': 'Vintage',
  'Siyah Beyaz': 'Zwart-wit',
  'Canlı': 'Levendig',
  'Analog': 'Analoog',
  'Kes': 'Knippen',
  'Hız': 'Snelheid',
  'Ses': 'Geluid',
  'Ses seviyesi': 'Volume',
  'Fotoğraf çek': 'Foto maken',
  'Video çek': 'Video opnemen',
  'Kolaj': 'Collage',
  'Düzen': 'Indeling',
  'Boşluk': 'Ruimte',
  'Köşe': 'Hoeken',
  'Kolaj oluşturulamadı': 'Collage kon niet worden gemaakt',
  ...
  'Eleştirmen': 'Critici',
  'Seyirci': 'Publiek',
  "2027'de Vizyona Girecek Filmler": "Films die uitkomen in 2027",
  "2027'de Başlayacak Diziler": "Series die starten in 2027",
  'Gizli hesap': 'Privéaccount',
  'Açıkken profilini yalnız onayladığın takipçiler görür; yeni takipler sana istek olarak gelir':
      'Als dit aanstaat, zien alleen door jou goedgekeurde volgers je profiel; nieuwe volgers komen als verzoeken binnen',
  'İstek Gönderildi': 'Aangevraagd',
  'Bu hesap gizli': 'Dit account is privé',
  'İsteğin bekliyor; onaylanınca izlediklerini, yorumlarını ve listelerini görebilirsin.':
      'Je verzoek wacht op goedkeuring; daarna zie je wat deze persoon kijkt, plus reacties en lijsten.',
  'İzlediklerini, yorumlarını ve listelerini görmek için takip isteği gönder; onaylanınca profil açılır.':
      'Stuur een volgverzoek om te zien wat deze persoon kijkt, plus reacties en lijsten; het profiel opent na goedkeuring.',
  '@{} seni takip etmek istiyor': '@{} wil je volgen',
  '@{} takip isteğini kabul etti': '@{} heeft je volgverzoek geaccepteerd',
  'Onayla': 'Goedkeuren',
  ...
  'Hemen kaydol': 'Nu registreren',
  'Dizilerini bölüm bölüm işaretle, film listeni tut, puanla ve yorumla; arkadaşlarının ne izlediğini gör. Web ve mobilde.':
      'Vink je series aflevering voor aflevering af, houd je filmlijst bij, beoordeel en recenseer, en zie wat je vrienden kijken. Op web en mobiel.',
  '45 dilde. Web, Android ve iOS.': 'In 45 talen. Web, Android en iOS.',
  'Takma ad': 'Bijnaam',
  'Bu adı yalnız sen görürsün': 'Alleen jij ziet deze naam',
  'Takma ad kaydedilemedi': 'Bijnaam kon niet worden opgeslagen',
  ...
  'Bu mesaj silindi': 'Dit bericht is verwijderd',
  'Benden sil': 'Verwijderen voor mij',
  'Herkesten sil': 'Verwijderen voor iedereen',
  'Sohbeti sil': 'Chat verwijderen',
  'Karşı taraftan da sil': 'Ook bij de ander verwijderen',
  'Yalnız senden silinir': 'Alleen bij jou verwijderd',
  '{} için de silinir': 'Ook verwijderd bij {}',
  'Bu sohbet senden silinecek. Geri alınamaz.':
      'Deze chat wordt bij jou verwijderd. Dit kan niet ongedaan worden gemaakt.',
  'Bu sohbet iki taraftan da silinecek. Geri alınamaz.':
      'Deze chat wordt aan beide kanten verwijderd. Dit kan niet ongedaan worden gemaakt.',
  'Sohbet silinemedi': 'Chat kon niet worden verwijderd',
  'İndiriliyor': 'Downloaden',
  'İndirildi': 'Gedownload',
  'Dosya indirilemedi': 'Bestand kon niet worden gedownload',
  'Bu dosyayı açacak uygulama yok': 'Geen app kan dit bestand openen',
  'Dosyanın yalnız başı gösteriliyor':
      'Alleen het begin van het bestand wordt getoond',
  // Kanon listeleri + çark seçeneği (kanon, 16 Eyl 2026)
  'Ölmeden İzlenmesi Gereken 100 Film': '100 films die je gezien moet hebben',
  'Ölmeden İzlenmesi Gereken 250 Film': '250 films die je gezien moet hebben',
  'Ölmeden İzlenmesi Gereken 500 Film': '500 films die je gezien moet hebben',
  'Ölmeden İzlenmesi Gereken 1000 Film': '1000 films die je gezien moet hebben',
  'Ölmeden İzlenmesi Gereken 10 Dizi': '10 series die je gezien moet hebben',
  'Ölmeden İzlenmesi Gereken 25 Dizi': '25 series die je gezien moet hebben',
  'Ölmeden İzlenmesi Gereken 50 Dizi': '50 series die je gezien moet hebben',
