...
const Map<String, String> cevirilerPl = {
  'dizi.jpg uygulamasını indir': 'Pobierz aplikację dizi.jpg',
  'Daha hızlı gezinme, bildirimler ve tam ekran deneyim uygulamada.':
      'Szybsze przeglądanie, powiadomienia i tryb pełnoekranowy są w aplikacji.',
  'Uygulamayı indir': 'Pobierz aplikację',
  'Tarayıcıda devam et': 'Kontynuuj w przeglądarce',
  'Bir bağlantı yapıştır ya da video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Wklej link lub prześlij wideo, zaproś znajomych i oglądajcie razem.',
  'URL yapıştır': 'Wklej link',
  'Yapıştır': 'Wklej',
  'Panoda görsel yok': 'Brak obrazu w schowku',
  'Video bağlantısı': 'Link do wideo',
  'Odada aç': 'Otwórz w pokoju',
  'Doğrudan video adresi': 'Bezpośredni adres wideo',
  '{} videosu': 'Wideo {}',
  'Başka video seç': 'Wybierz inne wideo',
  'Bu video adresi açılamadı': 'Nie udało się otworzyć tego adresu wideo',
  'Oda sahibi henüz video seçmedi':
      'Właściciel pokoju nie wybrał jeszcze wideo',
  'Bir video bağlantısı yapıştır ya da dosya yükle':
      'Wklej link do wideo lub prześlij plik',
  '{} bir video bağlantısı ekledi': '{} dodał(a) link do wideo',
  'Desteklenen siteler: {} · doğrudan video adresi (.mp4, .webm)':
      'Obsługiwane strony: {} · bezpośredni adres wideo (.mp4, .webm)',
  'Bu adres desteklenmiyor. Desteklenen siteler: {} · doğrudan video adresi (.mp4, .webm)':
      'Ten adres nie jest obsługiwany. Obsługiwane strony: {} · bezpośredni adres wideo (.mp4, .webm)',
  'Bu adres desteklenmiyor. {} bağlantısı ya da doğrudan bir video adresi (.mp4) yapıştır.':
      'Ten adres nie jest obsługiwany. Wklej link {} lub bezpośredni adres wideo (.mp4).',
  '{} · doğrudan video adresi (.mp4) · ya da en fazla {} GB dosya':
      '{} · bezpośredni adres wideo (.mp4) · lub plik do {} GB',
  '{} · doğrudan video adresi': '{} · Bezpośredni adres wideo',
  'Bu canlı yayın biçimini (m3u8) tarayıcı oynatamaz; telefon uygulamasında açılır.':
      'Przeglądarka nie odtworzy tego formatu (m3u8); otworzy się w aplikacji mobilnej.',
  ...
  'Veri içe aktar (.zip / .csv)': 'Importuj dane (.zip / .csv)',
  'Verilerim': 'Moje dane',
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'Używamy pamięci lokalnej, aby utrzymać Cię zalogowanym i zapamiętać preferencje takie jak język i motyw. W wersji internetowej działa Google Analytics, dzięki czemu widzimy zbiorczo, które części serwisu są używane; narzędzie to zapisuje w Twojej przeglądarce własny plik cookie pomiarowy. Nie ma plików cookie reklamowych ani służących do targetowania.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'Informacje o serialach i filmach pochodzą z TMDB, a informacje o dostawcach streamingu z JustWatch. Powiadomienia push są dostarczane przez Google Firebase, ruch w wersji internetowej jest mierzony za pomocą Google Analytics, a ruch w serwisie chroni Cloudflare. Usługi te podlegają własnym politykom prywatności.',
  ...
  'Apple ile devam et': 'Kontynuuj przez Apple',
  'Apple girişi başarısız': 'Logowanie przez Apple nie powiodło się',
  ...
  'Dışa aktardığın ZIP/CSV dosyasını seç; izlediklerin, puanların ve listelerin aktarılsın.':
      'Wybierz wyeksportowany plik ZIP/CSV, a przeniesiemy twoją historię oglądania, oceny i listy.',
  'Aktarılıyor...': 'Importowanie...',
  'ZIP/CSV dosyası seç': 'Wybierz plik ZIP/CSV',
  ...
  'dizi.jpg için en az 13 yaşında olmalısın.':
      'Musisz mieć co najmniej 13 lat, aby korzystać z dizi.jpg.',
  'En az 13 yaşında olmalısın': 'Musisz mieć co najmniej 13 lat',
  ...
  'Apple ile doğrula': 'Zweryfikuj przez Apple',
  'Hesabını Google ya da Apple ile açtıysan şifren yoktur; kimliğini o hesapla doğrula.':
      'Jeśli utworzyłeś konto przez Google lub Apple, nie masz hasła; zweryfikuj tożsamość tym kontem.',
  ...
  'Klavye': 'Klawiatura',
  'Kullanıcı adını seç': 'Wybierz nazwę użytkownika',
  'Google ile giriş yaptığın için adını biz türettik. Profil bağlantın ve etiketlenmelerin bu adla görünür; şimdi kendin seç.':
      'Ponieważ zalogowałeś się przez Google, wygenerowaliśmy nazwę za ciebie. Link do profilu i wzmianki jej używają — wybierz własną teraz.',
  'Kontrol ediliyor...': 'Sprawdzanie...',
  '@{} müsait': '@{} jest dostępna',
  'Bu adı seç': 'Wybierz tę nazwę',
  ...
  'Retro': 'Retro',
  'Vintage': 'Vintage',
  'Siyah Beyaz': 'Czarno-biały',
  'Canlı': 'Żywy',
  'Analog': 'Analogowy',
  'Kes': 'Przytnij',
  'Hız': 'Prędkość',
  'Ses': 'Dźwięk',
  'Ses seviyesi': 'Głośność',
  'Fotoğraf çek': 'Zrób zdjęcie',
  'Video çek': 'Nagraj wideo',
  'Kolaj': 'Kolaż',
  'Düzen': 'Układ',
  'Boşluk': 'Odstęp',
  'Köşe': 'Rogi',
  'Kolaj oluşturulamadı': 'Nie udało się utworzyć kolażu',
  ...
  'Dosya verisi gerekli': 'Wymagane są dane pliku',
  'Geçerli bir ZIP, CSV ya da JSON dosyası değil':
      'To nie jest prawidłowy plik ZIP, CSV ani JSON',
  'Dosya boş': 'Plik jest pusty',
  ...
  'İzin ver': 'Zezwól',
  'az önce': 'przed chwilą',
  '{} dk önce': '{} min temu',
  '{} dk önce~tekil': '{} min temu',
  '{} saat önce': '{} godz. temu',
  '{} saat önce~tekil': '{} godz. temu',
  '{} gün önce': '{} dni temu',
