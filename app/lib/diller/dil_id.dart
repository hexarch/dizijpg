...
const Map<String, String> cevirilerId = {
  ...
  "Tüm verini (izleme, puan, yorum, liste) TV Time uyumlu ZIP olarak al ya da TV Time / Letterboxd ZIP'ini içe aktar.":
      'Ekspor semua datamu (tontonan, nilai, komentar, daftar) sebagai ZIP yang kompatibel dengan TV Time, atau impor ZIP dari TV Time / Letterboxd.',
  'Tümünü Kaldır': 'Hapus Semua',
  'Tümünü İzledim': 'Sudah Nonton Semua',
  'Türk Dizileri': 'Serial Turki',
  'Veri içe aktar (.zip / .csv)': 'Impor data (.zip / .csv)',
  'Verilerim': 'Data Saya',
  ...
  'Altyazıyı aç': 'Nyalakan subtitle',
  'Altyazıyı kapat': 'Matikan subtitle',
  '10 saniye ileri': 'Maju 10 detik',
  '10 saniye geri': 'Mundur 10 detik',
  'Duraklat': 'Jeda',
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'Kami menggunakan penyimpanan lokal agar kamu tetap masuk dan agar preferensi seperti bahasa dan tema diingat. Di web, Google Analytics berjalan supaya kami bisa melihat secara agregat bagian situs mana yang digunakan; alat ini menulis cookie pengukurannya sendiri di browsermu. Tidak ada cookie iklan atau penargetan iklan.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'Informasi serial dan film berasal dari TMDB, dan informasi penyedia streaming dari JustWatch. Notifikasi push dikirim melalui Google Firebase, trafik web diukur dengan Google Analytics, dan trafik situs dilindungi oleh Cloudflare. Layanan ini tunduk pada kebijakan privasi masing-masing.',
  ...
  'Apple ile devam et': 'Lanjutkan dengan Apple',
  'Apple girişi başarısız': 'Masuk dengan Apple gagal',
  ...
  'Dışa aktardığın ZIP/CSV dosyasını seç; izlediklerin, puanların ve listelerin aktarılsın.':
      'Pilih file ZIP/CSV hasil ekspormu; tontonan, rating, dan daftarmu akan dipindahkan.',
  'Aktarılıyor...': 'Mengimpor...',
  'ZIP/CSV dosyası seç': 'Pilih file ZIP/CSV',
  ...
  'Altyazı görünümü': 'Tampilan subtitle',
  'Renk, yazı tipi, boyut, ayrıt ve opaklık':
      'Warna, font, ukuran, tepi, dan opasitas',
  'Bu bir örnek altyazıdır.': 'Ini adalah contoh subtitle.',
  'Ayar değiştikçe önizleme anında güncellenir.':
      'Pratinjau langsung diperbarui saat setelan diubah.',
  'Yazı biçimi': 'Gaya teks',
  'Yazı rengi': 'Warna teks',
  'Yazı opaklığı': 'Opasitas teks',
  'Yazı tipi': 'Font',
  'Yazı boyutu': 'Ukuran teks',
  'Karakter ayrıtı': 'Tepi karakter',
  ...
  'Arka plan opaklığı': 'Opasitas latar belakang',
  'Arka plan yazının hemen arkasındaki dolgudur; pencere ise tüm altyazı bloğunun arkasındaki daha geniş yüzey.':
      'Latar belakang adalah isian tepat di belakang teks; jendela adalah permukaan lebih lebar di belakang seluruh blok subtitle.',
  'Pencere': 'Jendela',
  'Pencere rengi': 'Warna jendela',
  'Pencere opaklığı': 'Opasitas jendela',
  'Altyazı görünümü sıfırlansın mı?': 'Setel ulang tampilan subtitle?',
  'Renk, yazı tipi, boyut, ayrıt ve opaklık ayarları varsayılana döner.':
      'Setelan warna, font, ukuran, tepi, dan opasitas akan kembali ke default.',
  'Altyazı görünümü varsayılana döndü': 'Tampilan subtitle kembali ke default',
  '{} indiriliyor…': 'Mengunduh {}…',
  'Seçince indirilir': 'Diunduh saat dipilih',
  'Yazı tipi indirilemedi. Varsayılan yazı tipiyle gösteriliyor.':
      'Font tidak dapat diunduh. Ditampilkan dengan font default.',
  'Beyaz': 'Putih',
  'Siyah': 'Hitam',
  'Kırmızı': 'Merah',
  'Yeşil': 'Hijau',
  ...
  'İstekler': 'Permintaan',
  'Reddettiğin istek yok': 'Tidak ada permintaan yang ditolak',
  ...
  '{} yıldız üzerinden': 'Dari {} bintang',
  'Önizleme': 'Pratinjau',
  'dokununca açılır': 'terbuka saat disentuh',
  'Bir azalt': 'Kurangi satu',
  ...
  'Ölçeği değiştirmek puanlarını silmez; aynı puanlar yeni ölçekte gösterilir.':
      'Mengubah skala tidak menghapus penilaianmu; penilaian yang sama ditampilkan pada skala baru.',
  ...
  'Dizi veya film seç (zorunlu)': 'Pilih serial atau film (wajib)',
  'Bölüm seç (isteğe bağlı)': 'Pilih episode (opsional)',
  '{}. sezon {}. bölüm': 'Musim {}, episode {}',
  'Ne düşünüyorsun?': 'Bagaimana menurutmu?',
  '{}/{} yükleniyor': 'Mengunggah {}/{}',
  'Fotoğraf/video ekle': 'Tambah foto atau video',
  'Paylaşmak için önce bir dizi veya film seç.':
      'Pilih dulu serial atau film untuk dibagikan.',
  'Sezon seç': 'Pilih musim',
  '{}. sezon': 'Musim {}',
  'Bölüm seçme (yalnız dizi hakkında)': 'Tanpa episode (hanya tentang serial)',
  'Sezonlar yüklenemedi.': 'Musim tidak dapat dimuat.',
  'Bu dizide bölüm bilgisi yok.': 'Tidak ada info episode untuk serial ini.',
  'Bu sezonda bölüm yok.': 'Tidak ada episode di musim ini.',
  '{}. bölüm': 'Episode {}',
  'Dizi veya film ara...': 'Cari serial dan film...',
  'İzlediğin dizi ve film hakkında yorum paylaş':
      'Bagikan komentar tentang yang kamu tonton',
  ...
  'Çarkı çevirmek için sürükle veya dokun':
      'Seret atau ketuk untuk memutar roda',
  'Arşiv': 'Arsip',
  'Yüklediklerim': 'Unggahan saya',
  'GIF ara...': 'Cari GIF...',
  'GIF yükle': 'Unggah GIF',
  'GIF etiketleri': 'Tag GIF',
  'Virgülle ayır. Aramada bu kelimelerle bulunur.':
      'Pisahkan dengan koma. Dengan kata-kata ini GIF ditemukan.',
  'gülme, alkış, şaşkın': 'tertawa, tepuk tangan, kaget',
  'Yükle': 'Unggah',
  'Henüz GIF yok': 'Belum ada GIF',
  'Bu aramaya uyan GIF yok': 'Tidak ada GIF yang cocok dengan pencarian ini',
  'Arşiv yeni. İlk GIF i sen yükle — sen hemen kullanırsın, onaydan sonra herkes görür.':
      'Arsipnya baru. Unggah GIF pertama — kamu bisa langsung memakainya, semua orang melihatnya setelah disetujui.',
  'GIF yüklendi. Sen hemen kullanabilirsin; herkese açık arşive onaydan sonra girer.':
      'GIF diunggah. Kamu bisa langsung memakainya; masuk ke arsip publik setelah disetujui.',
  'Onay bekliyor': 'Menunggu persetujuan',
  'GIF listesi yüklenemedi': 'Daftar GIF tidak dapat dimuat',
  'GIF yüklenemedi': 'GIF tidak dapat diunggah',
  ...
  'Apple ile doğrula': 'Verifikasi dengan Apple',
  'Hesabını Google ya da Apple ile açtıysan şifren yoktur; kimliğini o hesapla doğrula.':
      'Jika kamu membuat akun dengan Google atau Apple, kamu tidak punya kata sandi; verifikasi identitasmu dengan akun itu.',
  ...
  'Bu liste gizli': 'Daftar ini privat',
  'Bu kullanıcı izleme listelerini gizli tutmayı tercih ediyor.':
      'Pengguna ini memilih merahasiakan daftarnya.',
  'Bu listede henüz içerik yok': 'Belum ada judul di daftar ini',
  'Otomatik çeviri': 'Terjemahan otomatis',
  'Otomatik çeviri açıldı': 'Terjemahan otomatis diaktifkan',
  'Otomatik çeviri kapatıldı': 'Terjemahan otomatis dinonaktifkan',
  'Sohbet sessize alındı': 'Chat dibisukan',
  'Sessize alma kaldırıldı': 'Bisukan dibatalkan',
  'Tema özelleştir': 'Sesuaikan tema',
  'Sohbette ara': 'Cari di chat',
  'Mesajlarda ara...': 'Cari di pesan...',
  'Sonuç yok': 'Tidak ada hasil',
  'Profili gör': 'Lihat profil',
  'Medya ve dosyalar': 'Media dan berkas',
  ...
  'Temizle': 'Hapus',
  'Oyuncu': 'Aktor',
  'Böyle bir oda yok': 'Tidak ada ruang seperti itu',
  'Bu oda kapandı': 'Ruang ini sudah ditutup',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'Perlu undangan atau kode ruang untuk masuk',
  'Oda dolu': 'Ruang sudah penuh',
  'Bu odaya giremezsin': 'Kamu tidak bisa masuk ke ruang ini',
  'Bu odanın üyesi değilsin': 'Kamu bukan anggota ruang ini',
  'Bunu yalnız oda sahibi yapabilir': 'Hanya tuan rumah yang bisa melakukannya',
  'Oda sahibi odayı kapatmalı': 'Ruang harus ditutup oleh tuan rumah',
  'Zaten açık bir odan var': 'Kamu sudah punya ruang yang terbuka',
  'Oda kodu 6 karakter olmalı': 'Kode ruang harus 6 karakter',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'Akun tamu tidak bisa membuka ruang. Buat akun untuk membukanya.',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'Kamu hanya bisa mengundang orang yang mengikutimu balik',
  'Video en fazla {} GB olabilir': 'Video maksimal {} GB',
  'Yalnızca MP4 veya WebM izlenebilir': 'Hanya MP4 atau WebM yang bisa diputar',
  '{} odaya katıldı': '{} bergabung ke ruang',
  '{} odadan ayrıldı': '{} keluar dari ruang',
  '{} bir video yükledi': '{} mengunggah video',
  'bitti': 'selesai',
  '{} sn': '{} dtk',
  'Birlikte izle': 'Nonton bareng',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Unggah video, undang temanmu, dan tonton bersamaan.',
  'Henüz bir odan ya da davetin yok.': 'Kamu belum punya ruang atau undangan.',
  'Odaya katıl': 'Gabung ke ruang',
  'Oda kodu': 'Kode ruang',
  'Katıl': 'Gabung',
  'Oda oluştur': 'Buat ruang',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'Ruang menutup sendiri setelah 12 jam dan videonya dihapus.',
  'Odam': 'Ruangku',
  '@{} odası': 'Ruang @{}',
  'Seni davet etti': 'Mengundangmu',
  '{} kişi': '{} orang',
  'Video yok': 'Tidak ada video',
  '{} kaldı': 'Sisa {}',
  'Davet': 'Undangan',
  '@{} davet edildi': '@{} diundang',
  'Oda kodu kopyalandı': 'Kode ruang disalin',
  'Odayı kapat': 'Tutup ruang',
  'Odadan ayrıl': 'Keluar dari ruang',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'Ruang akan ditutup dan video dihapus. Tidak bisa dibatalkan.',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'Kamu akan keluar dari ruang. Bisa kembali dengan kode atau undangan.',
  'Ayrıl': 'Keluar',
  'İzleme odası': 'Ruang nonton',
  'Odalar 12 saat sonra kendiliğinden kapanır.':
      'Ruang menutup sendiri setelah 12 jam.',
  '{} kişi · {} kaldı': '{} orang · sisa {}',
  'Davet et': 'Undang',
  'Bir video yükle, izlemeye başlayın': 'Unggah video dan mulai menonton',
  'Oda sahibi henüz video yüklemedi': 'Tuan rumah belum mengunggah video',
  'Video yükle': 'Unggah video',
  'En fazla {} GB · MP4 veya WebM': 'Hingga {} GB · MP4 atau WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'Melanjutkan unggahan · {}/{} MB',
  'Yükleniyor · {}/{} MB': 'Mengunggah · {}/{} MB',
  'Videoyu değiştir': 'Ganti video',
  'Oda sahibiyle eşleniyor': 'Menyelaraskan dengan tuan rumah',
  'Sohbet boş': 'Obrolan masih kosong',
  'İzlerken buradan konuşabilirsiniz.':
      'Kalian bisa mengobrol di sini sambil menonton.',
  'oda sahibi': 'tuan rumah',
  'davet bekliyor': 'undangan menunggu',
  'çevrimdışı': 'offline',
  'Mesaj yaz...': 'Tulis pesan...',
  'Oda kodunu kopyala': 'Salin kode ruang',
  'Oda kodu {} — kopyala': 'Kode ruang {} — salin',
  'Arkadaşını davet et': 'Undang teman',
  'kullanıcı adı': 'nama pengguna',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'Kamu hanya bisa mengundang orang yang mengikutimu balik.',
  ...
  'Gizli hesap': 'Akun privat',
  'Açıkken profilini yalnız onayladığın takipçiler görür; yeni takipler sana istek olarak gelir':
      'Jika aktif, hanya pengikut yang kamu setujui yang melihat profilmu; pengikut baru masuk sebagai permintaan',
  'İstek Gönderildi': 'Diminta',
  'Bu hesap gizli': 'Akun ini privat',
  'İsteğin bekliyor; onaylanınca izlediklerini, yorumlarını ve listelerini görebilirsin.':
      'Permintaanmu menunggu; setelah disetujui kamu bisa melihat tontonan, komentar, dan daftarnya.',
  'İzlediklerini, yorumlarını ve listelerini görmek için takip isteği gönder; onaylanınca profil açılır.':
      'Kirim permintaan mengikuti untuk melihat tontonan, komentar, dan daftarnya; profil terbuka setelah disetujui.',
  ...
  'Dosya verisi gerekli': 'Data file diperlukan',
  'Geçerli bir ZIP, CSV ya da JSON dosyası değil':
      'Bukan file ZIP, CSV, atau JSON yang valid',
  'Dosya boş': 'File kosong',
  ...
  'Alıcı bir kez görebilir': 'Penerima hanya dapat melihat sekali',
  'Açıldı': 'Dibuka',
  'Flaş': 'Flash',
  'Fotoğraf çekilemedi': 'Tidak dapat mengambil foto',
  'Galeri izni gerekli': 'Perlu akses galeri',
  'Galeride medya yok': 'Tidak ada media di galeri',
  'Galeriden seç': 'Pilih dari galeri',
  'Görmek için dokun': 'Ketuk untuk melihat',
  'Konum': 'Lokasi',
  'Konum alınamadı': 'Tidak dapat mengambil lokasi',
  'Konum izni gerekli': 'Perlu izin lokasi',
  'Konum servisi kapalı': 'Layanan lokasi mati',
  'Konumum': 'Lokasi saya',
  'Mesaj ekle...': 'Tambahkan pesan...',
  'Son fotoğrafların burada görünsün diye galerine erişim gerekir.':
      'Akses galeri diperlukan untuk menampilkan foto terbaru di sini.',
  'Tek kullanımlık': 'Lihat sekali',
  'Tek kullanımlık fotoğraf': 'Foto sekali lihat',
  'Tek kullanımlık medya': 'Media sekali lihat',
  'Tek kullanımlık video': 'Video sekali lihat',
  'Tek kullanımlık yalnız tek fotoğraf veya videoda':
      'Lihat sekali hanya untuk satu foto atau video',
  'Video kaydedilemedi': 'Tidak dapat menyimpan video',
  'Video kaydı başlamadı': 'Perekaman video tidak dimulai',
  'Çek': 'Ambil',
