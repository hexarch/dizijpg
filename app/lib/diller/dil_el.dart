...
const Map<String, String> cevirilerEl = {
  'dizi.jpg uygulamasını indir': 'Λήψη της εφαρμογής dizi.jpg',
  'Daha hızlı gezinme, bildirimler ve tam ekran deneyim uygulamada.':
      'Η πιο γρήγορη περιήγηση, οι ειδοποιήσεις και η εμπειρία πλήρους οθόνης είναι στην εφαρμογή.',
  'Uygulamayı indir': 'Λήψη εφαρμογής',
  'Tarayıcıda devam et': 'Συνέχεια στο πρόγραμμα περιήγησης',
  'Bir bağlantı yapıştır ya da video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Επικολλήστε σύνδεσμο ή ανεβάστε βίντεο, καλέστε φίλους και δείτε μαζί.',
  'URL yapıştır': 'Επικόλληση συνδέσμου',
  'Yapıştır': 'Επικόλληση',
  'Panoda görsel yok': 'Δεν υπάρχει εικόνα στο πρόχειρο',
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'Χρησιμοποιούμε τον τοπικό χώρο αποθήκευσης για να παραμένεις συνδεδεμένος και για να θυμόμαστε προτιμήσεις όπως η γλώσσα και το θέμα. Στον ιστό λειτουργεί το Google Analytics, ώστε να βλέπουμε συνολικά ποια μέρη του ιστότοπου χρησιμοποιούνται· το εργαλείο αυτό γράφει στο πρόγραμμα περιήγησής σου το δικό του cookie μέτρησης. Δεν υπάρχουν cookies διαφήμισης ή στόχευσης.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'Οι πληροφορίες για σειρές και ταινίες προέρχονται από το TMDB και οι πληροφορίες για τους παρόχους streaming από το JustWatch. Οι ειδοποιήσεις push παραδίδονται μέσω του Google Firebase, η επισκεψιμότητα στον ιστό μετράται με το Google Analytics και η κίνηση του ιστότοπου προστατεύεται από το Cloudflare. Οι υπηρεσίες αυτές υπόκεινται στις δικές τους πολιτικές απορρήτου.',
  ...
  'dizi.jpg için en az 13 yaşında olmalısın.':
      'Πρέπει να είσαι τουλάχιστον 13 ετών για να χρησιμοποιήσεις το dizi.jpg.',
  'En az 13 yaşında olmalısın': 'Πρέπει να είσαι τουλάχιστον 13 ετών',
  ...
  'az önce': 'μόλις τώρα',
  '{} dk önce': 'πριν {} λεπτά',
  '{} dk önce~tekil': 'πριν {} λεπτό',
  '{} saat önce': 'πριν {} ώρες',
  '{} saat önce~tekil': 'πριν {} ώρα',
  '{} gün önce': 'πριν {} μέρες',
