...
const Map<String, String> cevirilerUr = {
  'dizi.jpg uygulamasını indir': 'dizi.jpg ایپ ڈاؤن لوڈ کریں',
  'Daha hızlı gezinme, bildirimler ve tam ekran deneyim uygulamada.':
      'تیز براؤزنگ، اطلاعات اور فل اسکرین تجربہ ایپ میں ہے۔',
  'Uygulamayı indir': 'ایپ ڈاؤن لوڈ کریں',
  'Tarayıcıda devam et': 'براؤزر میں جاری رکھیں',
  ...
  "Tüm verini (izleme, puan, yorum, liste) TV Time uyumlu ZIP olarak al ya da TV Time / Letterboxd ZIP'ini içe aktar.":
      'اپنا سارا ڈیٹا (واچ، ریٹنگ، تبصرے، لسٹیں) TV Time سے ہم آہنگ ZIP کے طور پر حاصل کریں یا TV Time / Letterboxd کی ZIP درآمد کریں۔',
  ...
  '• {} kitaplık kaydı': '• {} لائبریری اندراج',
  '• {} favori': '• {} پسندیدہ',
  ...
  'Apple ile devam et': 'Apple کے ساتھ جاری رکھیں',
  'Apple girişi başarısız': 'Apple سائن اِن ناکام ہو گیا',
  ...
  'dizi.jpg için en az 13 yaşında olmalısın.':
      'dizi.jpg استعمال کرنے کے لیے آپ کی عمر کم از کم 13 سال ہونی چاہیے۔',
  'En az 13 yaşında olmalısın': 'آپ کی عمر کم از کم 13 سال ہونی چاہیے',
  ...
  'Altyazı görünümü': 'سب ٹائٹل کی ظاہری شکل',
  'Renk, yazı tipi, boyut, ayrıt ve opaklık':
      'رنگ، فونٹ، سائز، کنارہ اور غیر شفافیت',
  'Bu bir örnek altyazıdır.': 'یہ ایک نمونہ سب ٹائٹل ہے۔',
  'Ayar değiştikçe önizleme anında güncellenir.':
      'ترتیب بدلتے ہی پیش منظر فوراً اپ ڈیٹ ہوتا ہے۔',
  'Yazı biçimi': 'متن کا انداز',
  'Yazı rengi': 'متن کا رنگ',
  'Yazı opaklığı': 'متن کی غیر شفافیت',
  'Yazı tipi': 'فونٹ',
  'Yazı boyutu': 'متن کا سائز',
  'Karakter ayrıtı': 'حروف کا کنارہ',
  'Ayrıt türü': 'کنارے کی قسم',
  'Ayrıt rengi': 'کنارے کا رنگ',
  'Yok': 'کوئی نہیں',
  'Dış çizgi': 'خاکہ',
  'Gölge': 'سایہ',
  'Kabartma': 'ابھرا ہوا',
  'Oyma': 'دھنسا ہوا',
  'Arka plan rengi': 'پس منظر کا رنگ',
  'Arka plan opaklığı': 'پس منظر کی غیر شفافیت',
  'Arka plan yazının hemen arkasındaki dolgudur; pencere ise tüm altyazı bloğunun arkasındaki daha geniş yüzey.':
      'پس منظر متن کے بالکل پیچھے کی بھرائی ہے؛ ونڈو پورے سب ٹائٹل بلاک کے پیچھے کی وسیع سطح ہے۔',
  'Pencere': 'ونڈو',
  'Pencere rengi': 'ونڈو کا رنگ',
  'Pencere opaklığı': 'ونڈو کی غیر شفافیت',
  'Altyazı görünümü sıfırlansın mı?': 'سب ٹائٹل کی ظاہری شکل ری سیٹ کریں؟',
  'Renk, yazı tipi, boyut, ayrıt ve opaklık ayarları varsayılana döner.':
      'رنگ، فونٹ، سائز، کنارہ اور غیر شفافیت کی ترتیبات ڈیفالٹ پر واپس آ جائیں گی۔',
  'Altyazı görünümü varsayılana döndü': 'سب ٹائٹل کی ظاہری شکل ڈیفالٹ پر آ گئی',
  '{} indiriliyor…': '{} ڈاؤن لوڈ ہو رہا ہے…',
  'Seçince indirilir': 'منتخب کرنے پر ڈاؤن لوڈ ہوگا',
  'Yazı tipi indirilemedi. Varsayılan yazı tipiyle gösteriliyor.':
      'فونٹ ڈاؤن لوڈ نہیں ہو سکا۔ ڈیفالٹ فونٹ میں دکھایا جا رہا ہے۔',
  'Beyaz': 'سفید',
  'Siyah': 'سیاہ',
  'Kırmızı': 'سرخ',
  'Yeşil': 'سبز',
  ...
  'Camgöbeği': 'سیان',
  'Macenta': 'میجنٹا',
  'Yapım bütçesi': 'پروڈکشن بجٹ',
  'Yapım bütçesi ve dünya çapında hasılat': 'پروڈکشن بجٹ اور دنیا بھر کی کمائی',
  'Dizinin yayın durumu': 'سیریز کی نشریات کی حالت',
  'Devam ediyor': 'جاری ہے',
  'Sona erdi': 'ختم ہو چکی',
  'İptal edildi': 'منسوخ ہو گئی',
  'Yapımda': 'زیرِ تیاری',
  'Planlandı': 'منصوبہ بندی میں',
  'Pilot bölüm': 'پائلٹ قسط',
  'Ad': 'نام',
  'Adın': 'تمہارا نام',
  'Kullanıcı adı': 'صارف نام',
  'Kullanıcı adını değiştir': 'صارف نام تبدیل کرو',
  'Kullanıcı adını 90 günde bir değiştirebilirsin':
      'صارف نام 90 دن میں ایک بار تبدیل کر سکتے ہو',
  'Değiştir': 'تبدیل کرو',
  '{} gün sonra değiştirebilirsin': '{} دن بعد تبدیل کر سکو گے',
  'Kullanıcı adın: @{}': 'تمہارا صارف نام: @{}',
  'Bu kullanıcı adı zaten alınmış': 'یہ صارف نام پہلے ہی لیا جا چکا ہے',
  'Bu kullanıcı adı şu an başka bir hesaba ayrılmış':
      'یہ صارف نام اس وقت کسی دوسرے اکاؤنٹ کے لیے محفوظ ہے',
  'Bu zaten senin kullanıcı adın': 'یہ تو پہلے ہی تمہارا صارف نام ہے',
  'Kullanıcı adı 3-20 karakter; küçük harf, rakam, nokta, tire ve alt çizgi kullanılabilir':
      'صارف نام 3–20 حروف؛ چھوٹے حروف، ہندسے، نقطہ، ہائفن، انڈر سکور',
  'Profilinde kullanıcı adının üstünde görünür. Boş bırakabilirsin.':
      'پروفائل میں تمہارے صارف نام کے اوپر دکھائی دیتا ہے۔ خالی بھی چھوڑ سکتے ہو۔',
  'Değiştirdikten sonra 90 gün boyunca tekrar değiştiremezsin. Eski kullanıcı adın 90 gün boyunca sana ayrılır — istersen geri dönebilirsin, o sürede başkası alamaz. Eski adına giden bağlantılar artık profilini açmaz.':
      'تبدیل کرنے کے بعد 90 دن تک دوبارہ تبدیل نہیں کر سکو گے۔ پرانا صارف نام 90 دن تک تمہارے لیے محفوظ رہے گا — چاہو تو واپس جا سکتے ہو، اس دوران کوئی اور نہیں لے سکتا۔ پرانے نام کے لنکس اب تمہاری پروفائل نہیں کھولیں گے۔',
  'Etkinliğim': 'سرگرمی',
  'Tercihler': 'ترجیحات',
  'Gizlilik ve güvenlik': 'رازداری اور سکیورٹی',
  'Destek': 'مدد',
  'Hesap': 'اکاؤنٹ',
  '{} dizileri': '{} کی سیریز',
  '{} filmleri': '{} کی فلمیں',
  ...
  'Bu kullanıcı adı sistem tarafından ayrılmış':
      'یہ صارف نام سسٹم کی طرف سے محفوظ ہے',
  'Ekran süresi': 'اسکرین وقت',
  ...
  'Kabul et': 'قبول کریں',
  'Reddedilenler': 'مسترد شدہ',
  'İstekler': 'درخواستیں',
  'Reddettiğin istek yok': 'کوئی مسترد شدہ درخواست نہیں',
  ...
  'Yıldız sistemi': 'ستارہ نظام',
  '{} yıldız üzerinden': '{} ستاروں میں سے',
  'Önizleme': 'پیش نظارہ',
  'dokununca açılır': 'ٹیپ پر کھلتا ہے',
  ...
  'Dizi veya film seç (zorunlu)': 'سیریز یا فلم منتخب کریں (لازمی)',
  'Bölüm seç (isteğe bağlı)': 'قسط منتخب کریں (اختیاری)',
  '{}. sezon {}. bölüm': 'سیزن {}، قسط {}',
  ...
  'Sezonlar yüklenemedi.': 'سیزن لوڈ نہیں ہو سکے۔',
  'Bu dizide bölüm bilgisi yok.': 'اس سیریز کی اقساط کی معلومات نہیں ہیں۔',
  ...
  'Apple ile doğrula': 'Apple سے تصدیق کریں',
  'Hesabını Google ya da Apple ile açtıysan şifren yoktur; kimliğini o hesapla doğrula.':
      'اگر آپ نے اکاؤنٹ Google یا Apple سے بنایا ہے تو آپ کا پاس ورڈ نہیں ہے؛ اسی اکاؤنٹ سے اپنی شناخت کی تصدیق کریں۔',
  ...
  'Temizle': 'صاف کریں',
  'Oyuncu': 'اداکار',
  'Böyle bir oda yok': 'ایسا کوئی کمرہ نہیں',
  'Bu oda kapandı': 'یہ کمرہ بند ہو چکا',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'داخل ہونے کے لیے دعوت یا کمرہ کوڈ چاہیے',
  'Oda dolu': 'کمرہ بھرا ہوا ہے',
  'Bu odaya giremezsin': 'آپ اس کمرے میں نہیں آ سکتے',
  'Bu odanın üyesi değilsin': 'آپ اس کمرے کے رکن نہیں',
  'Bunu yalnız oda sahibi yapabilir': 'یہ صرف کمرے کا میزبان کر سکتا ہے',
  'Oda sahibi odayı kapatmalı': 'کمرہ میزبان ہی بند کرے گا',
  'Zaten açık bir odan var': 'آپ کا ایک کمرہ پہلے سے کھلا ہے',
  'Oda kodu 6 karakter olmalı': 'کمرہ کوڈ 6 حروف کا ہونا چاہیے',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'مہمان اکاؤنٹ کمرہ نہیں کھول سکتے۔ کھولنے کے لیے اکاؤنٹ بنائیں۔',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'آپ صرف انہیں مدعو کر سکتے ہیں جو آپ کو واپس فالو کرتے ہیں',
  'Video en fazla {} GB olabilir': 'ویڈیو زیادہ سے زیادہ {} جی بی',
  'Yalnızca MP4 veya WebM izlenebilir': 'صرف MP4 یا WebM چل سکتی ہے',
  '{} odaya katıldı': '{} کمرے میں آ گئے',
  '{} odadan ayrıldı': '{} کمرے سے چلے گئے',
  '{} bir video yükledi': '{} نے ویڈیو اپ لوڈ کی',
  'bitti': 'ختم',
  '{} sn': '{} سیکنڈ',
  'Birlikte izle': 'ساتھ دیکھیں',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'ویڈیو اپ لوڈ کریں، دوستوں کو بلائیں اور ایک ساتھ دیکھیں۔',
  'Henüz bir odan ya da davetin yok.': 'ابھی آپ کے پاس نہ کمرہ ہے نہ دعوت۔',
  'Odaya katıl': 'کمرے میں شامل ہوں',
  'Oda kodu': 'کمرہ کوڈ',
  'Katıl': 'شامل ہوں',
  'Oda oluştur': 'کمرہ بنائیں',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'کمرے 12 گھنٹے بعد خود بند ہو جاتے ہیں اور ویڈیو حذف ہو جاتی ہے۔',
  'Odam': 'میرا کمرہ',
  '@{} odası': '@{} کا کمرہ',
  'Seni davet etti': 'آپ کو مدعو کیا',
  '{} kişi': '{} افراد',
  'Video yok': 'ویڈیو نہیں',
  '{} kaldı': '{} باقی',
  'Davet': 'دعوت',
  '@{} davet edildi': '@{} کو مدعو کیا گیا',
  'Oda kodu kopyalandı': 'کمرہ کوڈ کاپی ہو گیا',
  'Odayı kapat': 'کمرہ بند کریں',
  'Odadan ayrıl': 'کمرہ چھوڑیں',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'کمرہ بند ہو جائے گا اور ویڈیو حذف۔ یہ واپس نہیں ہو سکتا۔',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'آپ کمرہ چھوڑ دیں گے۔ کوڈ یا دعوت سے واپس آ سکتے ہیں۔',
  'Ayrıl': 'چھوڑیں',
  'İzleme odası': 'دیکھنے کا کمرہ',
  'Odalar 12 saat sonra kendiliğinden kapanır.':
      'کمرے 12 گھنٹے بعد خود بند ہو جاتے ہیں۔',
  '{} kişi · {} kaldı': '{} افراد · {} باقی',
  'Davet et': 'مدعو کریں',
  'Bir video yükle, izlemeye başlayın':
      'ویڈیو اپ لوڈ کریں اور دیکھنا شروع کریں',
  'Oda sahibi henüz video yüklemedi': 'میزبان نے ابھی ویڈیو اپ لوڈ نہیں کی',
  'Video yükle': 'ویڈیو اپ لوڈ کریں',
  'En fazla {} GB · MP4 veya WebM': '{} جی بی تک · MP4 یا WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'اپ لوڈ جاری · {}/{} ایم بی',
  'Yükleniyor · {}/{} MB': 'اپ لوڈ ہو رہی ہے · {}/{} ایم بی',
  'Videoyu değiştir': 'ویڈیو بدلیں',
  'Oda sahibiyle eşleniyor': 'میزبان کے ساتھ ہم آہنگ',
  'Sohbet boş': 'گفتگو خالی ہے',
  'İzlerken buradan konuşabilirsiniz.': 'دیکھتے ہوئے یہاں بات کر سکتے ہیں۔',
  'oda sahibi': 'میزبان',
  'davet bekliyor': 'دعوت زیرِ التوا',
  'çevrimdışı': 'آف لائن',
  'Mesaj yaz...': 'پیغام لکھیں...',
  'Oda kodunu kopyala': 'کمرہ کوڈ کاپی کریں',
  'Oda kodu {} — kopyala': 'کمرہ کوڈ {} — کاپی',
  'Arkadaşını davet et': 'دوست کو مدعو کریں',
  'kullanıcı adı': 'صارف نام',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'آپ صرف انہیں مدعو کر سکتے ہیں جو آپ کو واپس فالو کرتے ہیں۔',
  ...
  'Kişi ara...': 'لوگ تلاش کریں...',
  'Karşılıklı takipleştiğin kimse yok': 'ابھی کوئی آپ کو واپس فالو نہیں کرتا',
  'Böyle bir kullanıcı yok': 'ایسا کوئی صارف نہیں',
  'Oda kodunu paylaşarak da davet edebilirsin.':
      'کمرہ کوڈ شیئر کر کے بھی مدعو کر سکتے ہیں۔',
  'Karşılıklı takipleşmiyorsunuz': 'آپ ایک دوسرے کو فالو نہیں کرتے',
  'Odada': 'کمرے میں',
  'Davet edildi': 'مدعو کیا گیا',
  'Aşk': 'محبت',
  'Arkadaşlar': 'دوست',
  'Gece': 'رات',
  'Okyanus': 'سمندر',
  'Gün batımı': 'غروبِ آفتاب',
  'Orman': 'جنگل',
  'Neon': 'نیون',
  'Temalar': 'تھیمز',
  'Renkler': 'رنگ',
  ...
  'Değerlendirme': 'ریٹنگز',
  'Değerlendirmeler ({})': 'ریٹنگز ({})',
  'Henüz değerlendirme yok': 'ابھی کوئی ریٹنگ نہیں',
  'Puan verilen dizi ve filmler burada listelenir.':
      'ریٹ کیے گئے شوز اور فلمیں یہاں نظر آئیں گی۔',
  'Değerlendirmeler yüklenemedi': 'ریٹنگز لوڈ نہیں ہو سکیں',
  'Ayarla': 'ایڈجسٹ',
  'Filtre': 'فلٹر',
  'Çıkartma': 'اسٹیکر',
  'Parlaklık': 'چمک',
  ...
  'Eleştirmen': 'نقاد',
  'Seyirci': 'ناظرین',
  "2027'de Vizyona Girecek Filmler": "2027 میں آنے والی فلمیں",
  "2027'de Başlayacak Diziler": "2027 میں شروع ہونے والی سیریز",
  'Gizli hesap': 'نجی اکاؤنٹ',
  'Açıkken profilini yalnız onayladığın takipçiler görür; yeni takipler sana istek olarak gelir':
      'فعال ہونے پر آپ کا پروفائل صرف منظور شدہ فالوورز دیکھ سکتے ہیں؛ نئے فالو درخواست کی صورت میں آتے ہیں',
  'İstek Gönderildi': 'درخواست بھیج دی',
  'Bu hesap gizli': 'یہ اکاؤنٹ نجی ہے',
  'İsteğin bekliyor; onaylanınca izlediklerini, yorumlarını ve listelerini görebilirsin.':
      'آپ کی درخواست زیر التوا ہے؛ منظوری کے بعد آپ ان کے دیکھے گئے شوز، تبصرے اور فہرستیں دیکھ سکیں گے۔',
  'İzlediklerini, yorumlarını ve listelerini görmek için takip isteği gönder; onaylanınca profil açılır.':
      'ان کے دیکھے گئے شوز، تبصرے اور فہرستیں دیکھنے کے لیے فالو درخواست بھیجیں؛ منظوری پر پروفائل کھل جائے گا۔',
  '@{} seni takip etmek istiyor': '@{} آپ کو فالو کرنا چاہتے ہیں',
  '@{} takip isteğini kabul etti': '@{} نے آپ کی فالو درخواست قبول کر لی',
  'Onayla': 'منظور کریں',
  ...
  'İzlediğin her şeyi tek yerde takip et':
      'جو کچھ دیکھتے ہو سب ایک جگہ ٹریک کرو',
  'Keşfet\'e göz at': 'دریافت کریں دیکھیں',
  'Giriş yap': 'لاگ ان',
  'Neler yapabilirsin?': 'تم کیا کر سکتے ہو؟',
  'Bölüm bölüm takip': 'قسط بہ قسط ٹریکنگ',
  'Kaldığın yeri asla kaybetme: sezonları ve bölümleri tek dokunuşla işaretle, ilerlemeni gör.':
      'اپنی جگہ کبھی نہ کھوؤ: سیزن اور قسطیں ایک ٹیپ سے نشان زد کرو اور اپنی پیش رفت دیکھو۔',
  'Yeni bölümler ve vizyon tarihleri takviminde; hiçbir bölümü kaçırma.':
      'نئی قسطیں اور ریلیز کی تاریخیں تمہارے کیلنڈر میں؛ کوئی قسط نہ چھوٹے۔',
  'Puanla ve yorumla': 'ریٹنگ اور تبصرہ',
  'Ondalıklı puan ver, yorum yaz; IMDb, Rotten Tomatoes ve Metacritic puanlarını yan yana gör.':
      'اعشاری ریٹنگ دو، تبصرہ لکھو؛ IMDb، Rotten Tomatoes اور Metacritic کے اسکور ساتھ ساتھ دیکھو۔',
  'Kendi listelerin': 'تمہاری اپنی فہرستیں',
  'Listeler oluştur, sırala ve paylaş; izleme listen her cihazında seninle.':
      'فہرستیں بناؤ، ترتیب دو اور شیئر کرو؛ تمہاری واچ لسٹ ہر ڈیوائس پر تمہارے ساتھ۔',
  'Arkadaşlarınla': 'اپنے دوستوں کے ساتھ',
  'Akışta arkadaşlarının ne izlediğini gör, yorumlarına tepki ver, mesajlaş.':
      'فیڈ میں دیکھو دوست کیا دیکھ رہے ہیں، ان کے تبصروں پر ردعمل دو، پیغام بھیجو۔',
  'İzleme odasında aynı anda izleyin ve sohbet edin.':
      'واچ روم میں ایک ساتھ دیکھو اور چیٹ کرو۔',
  'Yapım verileri: TMDB': 'عنوانات کا ڈیٹا: TMDB',
  'Galeriye kaydet': 'گیلری میں محفوظ کریں',
  'Galeriye kaydedildi': 'گیلری میں محفوظ ہو گیا',
  'Galeriye kaydediliyor...': 'گیلری میں محفوظ کیا جا رہا ہے...',
  'Galeri izni verilmedi': 'گیلری کی اجازت نہیں دی گئی',
  'Kaydedilemedi': 'محفوظ نہیں ہو سکا',
  '{} medyayı galeriye kaydet': '{} میڈیا گیلری میں محفوظ کریں',
  '{}/{} kaydedildi': '{}/{} محفوظ ہوئے',
  'Hemen kaydol': 'ابھی رجسٹر کرو',
  ...
  'az önce': 'ابھی ابھی',
  '{} dk önce': '{} منٹ پہلے',
  '{} dk önce~tekil': '{} منٹ پہلے',
  '{} saat önce': '{} گھنٹے پہلے',
  '{} saat önce~tekil': '{} گھنٹہ پہلے',
  '{} gün önce': '{} دن پہلے',
