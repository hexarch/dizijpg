...
const Map<String, String> cevirilerCs = {
  'dizi.jpg uygulamasını indir': 'Stáhnout aplikaci dizi.jpg',
  'Daha hızlı gezinme, bildirimler ve tam ekran deneyim uygulamada.':
      'Rychlejší procházení, oznámení a režim celé obrazovky najdeš v aplikaci.',
  'Uygulamayı indir': 'Stáhnout aplikaci',
  'Tarayıcıda devam et': 'Pokračovat v prohlížeči',
  ...
  '{} ve {} yorumunu beğendi': '{} a {} se líbí tvůj komentář',
  '{} ve {} kişi yorumunu beğendi':
      '{} a dalším {} lidem se líbí tvůj komentář',
  ...
  'Oynat': 'Přehrát',
  'Fragmanı oynat': 'Přehrát trailer',
  'Altyazıyı aç': 'Zapnout titulky',
  'Altyazıyı kapat': 'Vypnout titulky',
  '10 saniye ileri': 'Přeskočit 10 sekund vpřed',
  '10 saniye geri': 'Přeskočit 10 sekund zpět',
  'Duraklat': 'Pozastavit',
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'Místní úložiště používáme k tomu, abys zůstal přihlášený a abychom si zapamatovali předvolby jako jazyk a téma. Na webu běží Google Analytics, abychom souhrnně viděli, které části stránek se používají; tento nástroj ukládá do tvého prohlížeče vlastní měřicí cookie. Reklamní ani cílicí cookies nepoužíváme.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'Informace o seriálech a filmech pocházejí z TMDB a informace o streamovacích službách z JustWatch. Push oznámení doručuje Google Firebase, webová návštěvnost se měří pomocí Google Analytics a provoz webu chrání Cloudflare. Tyto služby se řídí vlastními zásadami ochrany osobních údajů.',
  ...
  'Giriş gerekli': 'Je vyžadováno přihlášení',
  'Geçersiz oturum': 'Neplatná relace',
  'Oturum sonlandı, tekrar giriş yap': 'Relace skončila, přihlas se znovu',
  ...
  'E-posta/kullanıcı adı veya şifre hatalı':
      'E-mail/uživatelské jméno nebo heslo je špatně',
  'Bu e-posta veya kullanıcı adı zaten kayıtlı':
      'Tento e-mail nebo název už je obsazený',
  'Google doğrulaması başarısız': 'Ověření Google selhalo',
  'Kod geçersiz veya süresi dolmuş': 'Kód je neplatný nebo vypršel',
  'Bu kullanıcıyla mesajlaşamazsın': 'Tomuto uživateli nemůžeš napsat',
  'Kendini takip edemezsin': 'Nemůžeš sledovat sám sebe',
  'Bu kullanıcıyı takip edemezsin': 'Tohoto uživatele nemůžeš sledovat',
  'Kendini engelleyemezsin': 'Nemůžeš zablokovat sám sebe',
  'Yorum 1-1000 karakter olmalı': 'Komentář musí mít 1–1000 znaků',
  'Boş mesaj gönderilemez': 'Prázdnou zprávu nelze odeslat',
  'Yorum bulunamadı': 'Komentář nenalezen',
  'Şifre hatalı': 'Špatné heslo',
  'Şifre en az 6 karakter olmalı': 'Heslo musí mít alespoň 6 znaků',
  'Yalnızca GIF, PNG, JPEG veya WebP yüklenebilir':
      'Lze nahrát jen GIF, PNG, JPEG nebo WebP',
  'Desteklenen türler: GIF, PNG, JPEG, WebP, MP4, WebM, ses':
      'Podporované typy: GIF, PNG, JPEG, WebP, MP4, WebM, zvuk',
  'Geçerli bir ZIP dosyası değil': 'To není platný soubor ZIP',
  'Verilerini e-postayla almak için önce hesabına e-posta bağlamalısın':
      'Aby ti data přišla e-mailem, nejdřív připoj adresu',
  'Bu içerikte izleme kaydın var. "İzleyeceğim" demek için önce izleme işaretlerin silinmeli.':
      'Už tu máš značky zhlédnutí. Pro „Chci vidět“ je nejdřív smaž.',
  'Arama şu anda kapalı': 'Volání je teď vypnuté',
  'Misafir hesaplar arama ayarlarını açamaz; hesap oluşturunca kullanabilirsin':
      'Hostující účet hovory nezapne; nejdřív si založ účet',
  'Sunucu yeniden başlatılıyor, birazdan tekrar dene':
      'Server se restartuje, zkus to za chvíli',
  ...
  'dizi.jpg için en az 13 yaşında olmalısın.':
      'Pro používání dizi.jpg ti musí být alespoň 13 let.',
  'En az 13 yaşında olmalısın': 'Musí ti být alespoň 13 let',
  ...
  'Altyazı görünümü': 'Vzhled titulků',
  'Renk, yazı tipi, boyut, ayrıt ve opaklık':
      'Barva, písmo, velikost, okraj a neprůhlednost',
  'Bu bir örnek altyazıdır.': 'Toto je ukázkový titulek.',
  'Ayar değiştikçe önizleme anında güncellenir.':
      'Náhled se aktualizuje ihned při každé změně.',
  'Yazı biçimi': 'Styl textu',
  'Yazı rengi': 'Barva textu',
  'Yazı opaklığı': 'Neprůhlednost textu',
  'Yazı tipi': 'Písmo',
  'Yazı boyutu': 'Velikost textu',
  'Karakter ayrıtı': 'Okraj znaků',
  'Ayrıt türü': 'Typ okraje',
  'Ayrıt rengi': 'Barva okraje',
  'Yok': 'Žádný',
  'Dış çizgi': 'Obrys',
  'Gölge': 'Vržený stín',
  'Kabartma': 'Vyvýšený',
  'Oyma': 'Vpadlý',
  'Arka plan rengi': 'Barva pozadí',
  'Arka plan opaklığı': 'Neprůhlednost pozadí',
  'Arka plan yazının hemen arkasındaki dolgudur; pencere ise tüm altyazı bloğunun arkasındaki daha geniş yüzey.':
      'Pozadí je výplň hned za textem, okno je širší plocha za celým blokem titulků.',
  'Pencere': 'Okno',
  'Pencere rengi': 'Barva okna',
  'Pencere opaklığı': 'Neprůhlednost okna',
  'Altyazı görünümü sıfırlansın mı?': 'Obnovit vzhled titulků?',
  'Renk, yazı tipi, boyut, ayrıt ve opaklık ayarları varsayılana döner.':
      'Nastavení barvy, písma, velikosti, okraje a neprůhlednosti se vrátí na výchozí hodnoty.',
  'Altyazı görünümü varsayılana döndü': 'Vzhled titulků obnoven na výchozí',
  '{} indiriliyor…': 'Stahování {}…',
  'Seçince indirilir': 'Stáhne se při výběru',
  'Yazı tipi indirilemedi. Varsayılan yazı tipiyle gösteriliyor.':
      'Písmo se nepodařilo stáhnout. Zobrazuje se výchozím písmem.',
  'Beyaz': 'Bílá',
  'Siyah': 'Černá',
  'Kırmızı': 'Červená',
  'Yeşil': 'Zelená',
  ...
  'Kabul et': 'Přijmout',
  'Reddedilenler': 'Odmítnuté',
  'İstekler': 'Žádosti',
  'Reddettiğin istek yok': 'Žádné odmítnuté žádosti',
  'Reddettiğin istekler burada durur; dilersen geri kabul edebilirsin.':
      'Odmítnuté žádosti zůstávají tady; kdykoli je můžete znovu přijmout.',
  'Ne izlesem?': 'Co sledovat?',
  'Karışık': 'Mix',
  'Çarkı çevir': 'Roztočit kolo',
  ...
  'Yıldız sistemi': 'Systém hvězdiček',
  '{} yıldız üzerinden': 'Z {} hvězdiček',
  'Önizleme': 'Náhled',
  'dokununca açılır': 'otevře se klepnutím',
  ...
  'Dizi veya film seç (zorunlu)': 'Vyber seriál nebo film (povinné)',
  'Bölüm seç (isteğe bağlı)': 'Vyber epizodu (nepovinné)',
  '{}. sezon {}. bölüm': 'Sezóna {}, epizoda {}',
  ...
  'Pembe': 'Růžová',
  'Turuncu': 'Oranžová',
  'Orijinal metin gösteriliyor': 'Zobrazen původní text',
  ...
  'İzlediğim Diziler': 'Zhlédnuté seriály',
  'İzlediğim Filmler': 'Zhlédnuté filmy',
  'Satır görünümü': 'Zobrazení v řádcích',
  ...
  'Temizle': 'Vymazat',
  'Oyuncu': 'Herec',
  'Böyle bir oda yok': 'Taková místnost neexistuje',
  'Bu oda kapandı': 'Tato místnost byla uzavřena',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'Potřebuješ pozvánku nebo kód místnosti',
  'Oda dolu': 'Místnost je plná',
  'Bu odaya giremezsin': 'Do této místnosti nemůžeš',
  'Bu odanın üyesi değilsin': 'Nejsi členem této místnosti',
  'Bunu yalnız oda sahibi yapabilir': 'To může udělat jen hostitel místnosti',
  'Oda sahibi odayı kapatmalı': 'Místnost musí uzavřít hostitel',
  'Zaten açık bir odan var': 'Už máš otevřenou místnost',
  'Oda kodu 6 karakter olmalı': 'Kód místnosti musí mít 6 znaků',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'Účty hosta nemohou otevírat místnosti. Vytvoř si účet a můžeš ji otevřít.',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'Pozvat můžeš jen lidi, kteří tě sledují zpět',
  'Video en fazla {} GB olabilir': 'Video může mít nejvýše {} GB',
  'Yalnızca MP4 veya WebM izlenebilir': 'Přehrát lze jen MP4 nebo WebM',
  '{} odaya katıldı': '{} se připojil(a) do místnosti',
  '{} odadan ayrıldı': '{} opustil(a) místnost',
  '{} bir video yükledi': '{} nahrál(a) video',
  'bitti': 'konec',
  '{} sn': '{} s',
  'Birlikte izle': 'Sledujte spolu',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Nahraj video, pozvi kamarády a dívejte se současně.',
  'Henüz bir odan ya da davetin yok.': 'Zatím nemáš místnost ani pozvánku.',
  'Odaya katıl': 'Připojit se do místnosti',
  'Oda kodu': 'Kód místnosti',
  'Katıl': 'Připojit se',
  'Oda oluştur': 'Vytvořit místnost',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'Místnosti se po 12 hodinách samy zavřou a video se smaže.',
  'Odam': 'Moje místnost',
  '@{} odası': 'Místnost @{}',
  'Seni davet etti': 'Pozval(a) tě',
  '{} kişi': '{} lidí',
  'Video yok': 'Bez videa',
  '{} kaldı': 'Zbývá {}',
  'Davet': 'Pozvánka',
  '@{} davet edildi': '@{} pozván(a)',
  'Oda kodu kopyalandı': 'Kód místnosti zkopírován',
  'Odayı kapat': 'Zavřít místnost',
  'Odadan ayrıl': 'Opustit místnost',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'Místnost se zavře a video se smaže. Nelze to vrátit zpět.',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'Opustíš místnost. Vrátit se můžeš s kódem nebo pozvánkou.',
  'Ayrıl': 'Opustit',
  'İzleme odası': 'Sledovací místnost',
  'Odalar 12 saat sonra kendiliğinden kapanır.':
      'Místnosti se po 12 hodinách samy zavřou.',
  '{} kişi · {} kaldı': '{} lidí · zbývá {}',
  'Davet et': 'Pozvat',
  'Bir video yükle, izlemeye başlayın': 'Nahraj video a začněte sledovat',
  'Oda sahibi henüz video yüklemedi': 'Hostitel zatím nenahrál video',
  'Video yükle': 'Nahrát video',
  'En fazla {} GB · MP4 veya WebM': 'Až {} GB · MP4 nebo WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'Pokračuje nahrávání · {}/{} MB',
  'Yükleniyor · {}/{} MB': 'Nahrávání · {}/{} MB',
  'Videoyu değiştir': 'Změnit video',
  'Oda sahibiyle eşleniyor': 'Synchronizace s hostitelem',
  'Sohbet boş': 'Chat je prázdný',
  'İzlerken buradan konuşabilirsiniz.': 'Tady si můžete povídat při sledování.',
  'oda sahibi': 'hostitel',
  'davet bekliyor': 'čeká na pozvánku',
  'çevrimdışı': 'offline',
  'Mesaj yaz...': 'Napiš zprávu...',
  'Oda kodunu kopyala': 'Zkopírovat kód místnosti',
  'Oda kodu {} — kopyala': 'Kód místnosti {} — zkopírovat',
  'Arkadaşını davet et': 'Pozvi kamaráda',
  'kullanıcı adı': 'uživatelské jméno',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'Pozvat můžeš jen lidi, kteří tě sledují zpět.',
  ...
  'Kişi ara...': 'Hledat lidi...',
  'Karşılıklı takipleştiğin kimse yok': 'Nikdo tě zatím nesleduje zpět',
  'Böyle bir kullanıcı yok': 'Takový uživatel neexistuje',
  'Oda kodunu paylaşarak da davet edebilirsin.':
      'Pozvat můžeš i sdílením kódu místnosti.',
  'Karşılıklı takipleşmiyorsunuz': 'Nesledujete se navzájem',
  'Odada': 'V místnosti',
  'Davet edildi': 'Pozván',
  'Aşk': 'Láska',
  'Arkadaşlar': 'Přátelé',
  ...
  'Temalar': 'Motivy',
  'Renkler': 'Barvy',
  'Sık kullanılanlar': 'Často používané',
  'Klavye': 'Klávesnice',
  'Kullanıcı adını seç': 'Zvol si uživatelské jméno',
  'Google ile giriş yaptığın için adını biz türettik. Profil bağlantın ve etiketlenmelerin bu adla görünür; şimdi kendin seç.':
      'Protože ses přihlásil přes Google, jméno jsme vygenerovali za tebe. Odkaz na profil a zmínky ho používají — vyber si teď vlastní.',
  'Kontrol ediliyor...': 'Kontroluji...',
  '@{} müsait': '@{} je volné',
  'Bu adı seç': 'Použít toto jméno',
  ...
  'Retro': 'Retro',
  'Vintage': 'Vintage',
  'Siyah Beyaz': 'Černobílý',
  'Canlı': 'Živý',
  'Analog': 'Analogový',
  'Kes': 'Střih',
  'Hız': 'Rychlost',
  'Ses': 'Zvuk',
  'Ses seviyesi': 'Hlasitost',
  'Fotoğraf çek': 'Vyfotit',
  'Video çek': 'Natočit video',
  'Kolaj': 'Koláž',
  'Düzen': 'Rozložení',
  'Boşluk': 'Mezera',
  'Köşe': 'Rohy',
  'Kolaj oluşturulamadı': 'Koláž se nepodařilo vytvořit',
  ...
  'Galeriye kaydet': 'Uložit do galerie',
  'Galeriye kaydedildi': 'Uloženo do galerie',
  'Galeriye kaydediliyor...': 'Ukládání do galerie...',
  'Galeri izni verilmedi': 'Přístup ke galerii nebyl povolen',
