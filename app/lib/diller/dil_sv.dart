...
const Map<String, String> cevirilerSv = {
  'dizi.jpg uygulamasını indir': 'Ladda ner dizi.jpg-appen',
  'Daha hızlı gezinme, bildirimler ve tam ekran deneyim uygulamada.':
      'Snabbare surfande, aviseringar och helskärmsläge finns i appen.',
  'Uygulamayı indir': 'Ladda ner appen',
  'Tarayıcıda devam et': 'Fortsätt i webbläsaren',
  ...
  "Tüm verini (izleme, puan, yorum, liste) TV Time uyumlu ZIP olarak al ya da TV Time / Letterboxd ZIP'ini içe aktar.":
      'Exportera alla dina data (historik, betyg, kommentarer, listor) som en TV Time-kompatibel ZIP eller importera en ZIP från TV Time / Letterboxd.',
  'Tümünü Kaldır': 'Ta bort alla',
  'Tümünü İzledim': 'Har sett alla',
  'Türk Dizileri': 'Turkiska serier',
  'Veri içe aktar (.zip / .csv)': 'Importera data (.zip / .csv)',
  'Verilerim': 'Mina data',
  ...
  '• {} kitaplık kaydı': '• {} biblioteksposter',
  '• {} favori': '• {} favoriter',
  ...
  '{} ve {} yorumunu beğendi': '{} och {} gillade din kommentar',
  '{} ve {} kişi yorumunu beğendi': '{} och {} andra gillade din kommentar',
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'Vi använder lokal lagring för att hålla dig inloggad och för att komma ihåg inställningar som språk och tema. På webben körs Google Analytics så att vi kan se på aggregerad nivå vilka delar av sajten som används; verktyget skriver en egen mätcookie i din webbläsare. Det finns inga annons- eller spårningscookies för marknadsföring.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'Information om serier och filmer kommer från TMDB och information om streamingtjänster från JustWatch. Pushnotiser levereras via Google Firebase, webbtrafiken mäts med Google Analytics och sajtens trafik skyddas av Cloudflare. Dessa tjänster omfattas av sina egna integritetspolicyer.',
  ...
  'Apple ile devam et': 'Fortsätt med Apple',
  'Apple girişi başarısız': 'Inloggning med Apple misslyckades',
  ...
  'Dışa aktardığın ZIP/CSV dosyasını seç; izlediklerin, puanların ve listelerin aktarılsın.':
      'Välj ZIP/CSV-filen du har exporterat, så följer din tittarhistorik, dina betyg och dina listor med.',
  'Aktarılıyor...': 'Importerar...',
  'ZIP/CSV dosyası seç': 'Välj ZIP/CSV-fil',
  ...
  'dizi.jpg için en az 13 yaşında olmalısın.':
      'Du måste vara minst 13 år för att använda dizi.jpg.',
  'En az 13 yaşında olmalısın': 'Du måste vara minst 13 år',
  ...
  'Altyazı görünümü': 'Undertexternas utseende',
  'Renk, yazı tipi, boyut, ayrıt ve opaklık':
      'Färg, teckensnitt, storlek, kant och opacitet',
  'Bu bir örnek altyazıdır.': 'Det här är en exempelundertext.',
  'Ayar değiştikçe önizleme anında güncellenir.':
      'Förhandsvisningen uppdateras direkt när du ändrar en inställning.',
  'Yazı biçimi': 'Textstil',
  'Yazı rengi': 'Textfärg',
  'Yazı opaklığı': 'Textens opacitet',
  'Yazı tipi': 'Teckensnitt',
  'Yazı boyutu': 'Textstorlek',
  'Karakter ayrıtı': 'Teckenkant',
  'Ayrıt türü': 'Kanttyp',
  'Ayrıt rengi': 'Kantfärg',
  'Yok': 'Ingen',
  'Dış çizgi': 'Kontur',
  'Gölge': 'Skugga',
  'Kabartma': 'Upphöjd',
  'Oyma': 'Nedsänkt',
  'Arka plan rengi': 'Bakgrundsfärg',
  'Arka plan opaklığı': 'Bakgrundens opacitet',
  'Arka plan yazının hemen arkasındaki dolgudur; pencere ise tüm altyazı bloğunun arkasındaki daha geniş yüzey.':
      'Bakgrunden är fyllningen precis bakom texten; fönstret är den bredare ytan bakom hela undertextblocket.',
  'Pencere': 'Fönster',
  'Pencere rengi': 'Fönsterfärg',
  'Pencere opaklığı': 'Fönstrets opacitet',
  'Altyazı görünümü sıfırlansın mı?': 'Återställa undertexternas utseende?',
  'Renk, yazı tipi, boyut, ayrıt ve opaklık ayarları varsayılana döner.':
      'Inställningarna för färg, teckensnitt, storlek, kant och opacitet återgår till standard.',
  'Altyazı görünümü varsayılana döndü': 'Undertexternas utseende återställt',
  '{} indiriliyor…': 'Laddar ned {}…',
  'Seçince indirilir': 'Laddas ned när du väljer det',
  'Yazı tipi indirilemedi. Varsayılan yazı tipiyle gösteriliyor.':
      'Det gick inte att ladda ned teckensnittet. Visas med standardteckensnittet.',
  'Beyaz': 'Vit',
  'Siyah': 'Svart',
  'Kırmızı': 'Röd',
  'Yeşil': 'Grön',
  ...
  'Yapım bütçesi ve dünya çapında hasılat':
      'Produktionsbudget och intäkter världen över',
  'Dizinin yayın durumu': 'Seriens sändningsstatus',
  'Devam ediyor': 'Pågår',
  'Sona erdi': 'Avslutad',
  'İptal edildi': 'Nedlagd',
  'Yapımda': 'Under produktion',
  'Planlandı': 'Planerad',
  'Pilot bölüm': 'Pilotavsnitt',
  'Ad': 'Namn',
  'Adın': 'Ditt namn',
  'Kullanıcı adı': 'Användarnamn',
  'Kullanıcı adını değiştir': 'Ändra användarnamn',
  'Kullanıcı adını 90 günde bir değiştirebilirsin':
      'Du kan ändra ditt användarnamn en gång var 90:e dag',
  'Değiştir': 'Ändra',
  '{} gün sonra değiştirebilirsin': 'Du kan ändra om {} dagar',
  'Kullanıcı adın: @{}': 'Ditt användarnamn: @{}',
  'Bu kullanıcı adı zaten alınmış': 'Det användarnamnet är redan taget',
  'Bu kullanıcı adı şu an başka bir hesaba ayrılmış':
      'Det användarnamnet är just nu reserverat för ett annat konto',
  'Bu zaten senin kullanıcı adın': 'Det är redan ditt användarnamn',
  'Kullanıcı adı 3-20 karakter; küçük harf, rakam, nokta, tire ve alt çizgi kullanılabilir':
      'Användarnamn 3–20 tecken; gemener, siffror, punkter, bindestreck, understreck',
  'Profilinde kullanıcı adının üstünde görünür. Boş bırakabilirsin.':
      'Visas ovanför ditt användarnamn på profilen. Du kan lämna det tomt.',
  'Değiştirdikten sonra 90 gün boyunca tekrar değiştiremezsin. Eski kullanıcı adın 90 gün boyunca sana ayrılır — istersen geri dönebilirsin, o sürede başkası alamaz. Eski adına giden bağlantılar artık profilini açmaz.':
      'Efter ändringen kan du inte ändra igen på 90 dagar. Ditt gamla användarnamn är reserverat åt dig i 90 dagar — du kan byta tillbaka och ingen annan kan ta det under tiden. Länkar till ditt gamla namn öppnar inte längre din profil.',
  'Etkinliğim': 'Aktivitet',
  'Tercihler': 'Preferenser',
  'Gizlilik ve güvenlik': 'Integritet och säkerhet',
  'Destek': 'Support',
  'Hesap': 'Konto',
  '{} dizileri': 'Serier av {}',
  '{} filmleri': 'Filmer av {}',
  'En üste taşı': 'Flytta överst',
  'Sırayı sıfırla': 'Återställ ordningen',
  'Listede ara': 'Sök i listan',
  'Elle sıra sıfırlansın mı?': 'Vill du återställa den manuella ordningen?',
  'Liste varsayılan sırasına (en son işaretlediğin önce) döner.':
      'Listan återgår till standardordningen (senast markerat först).',
  'Sıra sıfırlanamadı': 'Ordningen kunde inte återställas',
  'Listenin en üstüne taşındı': 'Flyttad överst i listan',
  'Adlar yükleniyor…': 'Läser in titlar…',
  'Afişe basılı tutup sürükle. Uzaktaki bir yapımı öne almak için "En üste taşı"yı kullan.':
      'Håll ned en affisch för att dra den. Använd ”Flytta överst” för att ta fram en titel som ligger långt bort.',
  'Aramada sürükleme kapalı; "En üste taşı" ile öne al ({} sonuç).':
      'Dragning är avstängd i sökningen; ta fram den med ”Flytta överst” ({} träffar).',
  'Görünüm': 'Vy',
  'En çok izlediğin filmler': 'Dina mest sedda filmer',
  'Süreler tahmindir: bölüm ~{} dk, film ~{} dk sayılır':
      'Tiderna är uppskattningar: ett avsnitt räknas som ~{} min, en film som ~{} min',
  'Bu kullanıcı adı sistem tarafından ayrılmış':
      'Det användarnamnet är reserverat av systemet',
  'Ekran süresi': 'Skärmtid',
  "Süreler TMDB'deki gerçek bölüm ve film süreleridir":
      'Tiderna är de faktiska speltiderna för avsnitt och filmer från TMDB',
  'Tüm zamanlar: {} bölüm · {} film · {}':
      'Genom tiderna: {} avsnitt · {} filmer · {}',
  'Kabul et': 'Acceptera',
  'Reddedilenler': 'Avvisade',
  'İstekler': 'Förfrågningar',
  'Reddettiğin istek yok': 'Inga avvisade förfrågningar',
  ...
  'Yıldız sistemi': 'Stjärnsystem',
  '{} yıldız üzerinden': 'Av {} stjärnor',
  'Önizleme': 'Förhandsvisning',
  'dokununca açılır': 'öppnas vid tryck',
  ...
  'Dizi veya film seç (zorunlu)': 'Välj en serie eller film (obligatoriskt)',
  'Bölüm seç (isteğe bağlı)': 'Välj ett avsnitt (valfritt)',
  '{}. sezon {}. bölüm': 'Säsong {}, avsnitt {}',
  ...
  'Dizinin kendisi': 'Själva serien',
  'Sezon ya da bölüm seçme': 'Ingen säsong eller avsnitt',
  'Tüm {}. sezon': 'Hela säsong {}',
  'Bölüm seçme': 'Inget avsnitt',
  'En fazla {} yapım ekleyebilirsin.': 'Du kan lägga till upp till {} titlar.',
  'Bu zaten ekli.': 'Redan tillagd.',
  'Dizi, film, oyuncu ya da yönetmen etiketle — gönderin onların sayfasında da görünür.':
      'Tagga en serie, film, skådespelare eller regissör – ditt inlägg visas även på deras sida.',
  'Etiket ekle': 'Lägg till tagg',
  'Dizi, film, oyuncu ya da yönetmen etiketle':
      'Tagga en serie, film, skådespelare eller regissör',
  'Gönderiden vazgeç': 'Släng inlägget',
  'Yazdıkların kaydedilmeyecek.': 'Det du skrev sparas inte.',
  'Yazmaya devam et': 'Fortsätt skriva',
  ...
  'ya da': 'eller',
  'Google ile doğrula': 'Verifiera med Google',
  'Apple ile doğrula': 'Verifiera med Apple',
  'Hesabını Google ya da Apple ile açtıysan şifren yoktur; kimliğini o hesapla doğrula.':
      'Om du skapade ditt konto med Google eller Apple har du inget lösenord; verifiera din identitet med det kontot.',
  'Hesabını Google ile açtıysan şifren yoktur; kimliğini Google ile doğrula.':
      'Om du skapade kontot med Google har du inget lösenord; verifiera din identitet med Google.',
  'Google doğrulaması bu hesapla eşleşmedi':
      'Google-verifieringen matchade inte det här kontot',
  'Bu hesap Google ile açıldı; doğrulamak için Google ile giriş yap':
      'Det här kontot skapades med Google; logga in med Google för att verifiera',
  // --- 31 Agu 2026: kitaplik paylasimi + reels ceviri + sohbet detayi ---
  'Bu liste gizli': 'Den här listan är privat',
  'Bu kullanıcı izleme listelerini gizli tutmayı tercih ediyor.':
      'Den här användaren håller sina listor privata.',
  'Bu listede henüz içerik yok': 'Inga titlar i den här listan ännu',
  'Otomatik çeviri': 'Automatisk översättning',
  'Otomatik çeviri açıldı': 'Automatisk översättning på',
  'Otomatik çeviri kapatıldı': 'Automatisk översättning av',
  'Sohbet sessize alındı': 'Chatten är tystad',
  'Sessize alma kaldırıldı': 'Tystnad borttagen',
  'Tema özelleştir': 'Anpassa tema',
  'Sohbette ara': 'Sök i chatten',
  'Mesajlarda ara...': 'Sök i meddelanden...',
  'Sonuç yok': 'Inga resultat',
  'Profili gör': 'Visa profil',
  'Medya ve dosyalar': 'Media och filer',
  'Henüz medya yok': 'Ingen media ännu',
  'Varsayılan': 'Standard',
  'Mor': 'Lila',
  'Pembe': 'Rosa',
  'Turuncu': 'Orange',
  'Orijinal metin gösteriliyor': 'Visar originaltexten',
  'İnternet bağlantısı yok': 'Ingen internetanslutning',
  'Sunucu yanıt vermedi': 'Servern svarade inte',
  ...
  'Sesli mesaj (basılı tut)': 'Röstmeddelande (håll)',
  'Kaydetmek için basılı tut': 'Håll för att spela in',
  'Kaydırarak iptal': 'Svep för att avbryta',
  'Kamera açılamadı': 'Kameran kunde inte öppnas',
  'Dosya seçilemedi': 'Filen kunde inte väljas',
  'Dosya gönderilemedi': 'Filen kunde inte skickas',
  'En yeni mesaja in': 'Till senaste meddelandet',
  'Gönderilemedi · tekrar dene': 'Inte skickat · försök igen',
  'Dosya açılamadı': 'Filen kunde inte öppnas',
  'Temizle': 'Rensa',
  'Oyuncu': 'Skådespelare',
  'Böyle bir oda yok': 'Det finns inget sådant rum',
  'Bu oda kapandı': 'Det här rummet är stängt',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'Du behöver en inbjudan eller en rumskod',
  'Oda dolu': 'Rummet är fullt',
  'Bu odaya giremezsin': 'Du kan inte gå in i det här rummet',
  'Bu odanın üyesi değilsin': 'Du är inte medlem i det här rummet',
  'Bunu yalnız oda sahibi yapabilir': 'Bara rummets värd kan göra det',
  'Oda sahibi odayı kapatmalı': 'Värden måste stänga rummet',
  'Zaten açık bir odan var': 'Du har redan ett öppet rum',
  'Oda kodu 6 karakter olmalı': 'Rumskoden måste vara 6 tecken',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'Gästkonton kan inte öppna tittarrum. Skapa ett konto för att öppna ett.',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'Du kan bara bjuda in personer som följer dig tillbaka',
  'Video en fazla {} GB olabilir': 'Videon får vara högst {} GB',
  'Yalnızca MP4 veya WebM izlenebilir': 'Bara MP4 eller WebM kan spelas upp',
  '{} odaya katıldı': '{} gick med i rummet',
  '{} odadan ayrıldı': '{} lämnade rummet',
  '{} bir video yükledi': '{} laddade upp en video',
  'bitti': 'slut',
  '{} sn': '{} s',
  'Birlikte izle': 'Titta tillsammans',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Ladda upp en video, bjud in dina vänner och titta samtidigt.',
  'Henüz bir odan ya da davetin yok.':
      'Du har varken ett rum eller en inbjudan än.',
  'Odaya katıl': 'Gå med i ett rum',
  'Oda kodu': 'Rumskod',
  'Katıl': 'Gå med',
  'Oda oluştur': 'Skapa rum',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'Rum stängs av sig själva efter 12 timmar och videon raderas.',
  'Odam': 'Mitt rum',
  '@{} odası': '@{}s rum',
  'Seni davet etti': 'Har bjudit in dig',
  '{} kişi': '{} personer',
  'Video yok': 'Ingen video',
  '{} kaldı': '{} kvar',
  'Davet': 'Inbjudan',
  '@{} davet edildi': '@{} inbjuden',
  'Oda kodu kopyalandı': 'Rumskoden kopierad',
  'Odayı kapat': 'Stäng rummet',
  'Odadan ayrıl': 'Lämna rummet',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'Rummet stängs och videon raderas. Det går inte att ångra.',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'Du lämnar rummet. Du kan komma tillbaka med koden eller en inbjudan.',
  'Ayrıl': 'Lämna',
  'İzleme odası': 'Tittarrum',
  'Odalar 12 saat sonra kendiliğinden kapanır.':
      'Rum stängs av sig själva efter 12 timmar.',
  '{} kişi · {} kaldı': '{} personer · {} kvar',
  'Davet et': 'Bjud in',
  'Bir video yükle, izlemeye başlayın': 'Ladda upp en video och börja titta',
  'Oda sahibi henüz video yüklemedi':
      'Värden har inte laddat upp någon video än',
  'Video yükle': 'Ladda upp video',
  'En fazla {} GB · MP4 veya WebM': 'Upp till {} GB · MP4 eller WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'Återupptar uppladdning · {}/{} MB',
  'Yükleniyor · {}/{} MB': 'Laddar upp · {}/{} MB',
  'Videoyu değiştir': 'Byt video',
  'Oda sahibiyle eşleniyor': 'Synkroniserar med värden',
  'Sohbet boş': 'Chatten är tom',
  'İzlerken buradan konuşabilirsiniz.': 'Här kan ni prata medan ni tittar.',
  'oda sahibi': 'värd',
  'davet bekliyor': 'inbjudan väntar',
  'çevrimdışı': 'offline',
  'Mesaj yaz...': 'Skriv ett meddelande...',
  'Oda kodunu kopyala': 'Kopiera rumskod',
  'Oda kodu {} — kopyala': 'Rumskod {} — kopiera',
  'Arkadaşını davet et': 'Bjud in en vän',
  'kullanıcı adı': 'användarnamn',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'Du kan bara bjuda in personer som följer dig tillbaka.',
  'Oda açılamadı': 'Rummet kunde inte öppnas',
  'Tam ekrandan çık': 'Avsluta helskärm',
  'Sohbeti gizle': 'Dölj chatt',
  'Sohbeti göster': 'Visa chatt',
  'Fragman': 'Trailer',
  'Tekrar oynat': 'Spela upp igen',
  ...
  'Kişi ara...': 'Sök personer...',
  'Karşılıklı takipleştiğin kimse yok': 'Ingen följer dig tillbaka än',
  'Böyle bir kullanıcı yok': 'Den användaren finns inte',
  'Oda kodunu paylaşarak da davet edebilirsin.':
      'Du kan också bjuda in genom att dela rumskoden.',
  'Karşılıklı takipleşmiyorsunuz': 'Ni följer inte varandra',
  'Odada': 'I rummet',
  'Davet edildi': 'Inbjuden',
  'Aşk': 'Kärlek',
  'Arkadaşlar': 'Vänner',
  ...
  'Temalar': 'Teman',
  'Renkler': 'Färger',
  'Sık kullanılanlar': 'Ofta använda',
  'Klavye': 'Tangentbord',
  'Kullanıcı adını seç': 'Välj ditt användarnamn',
  'Google ile giriş yaptığın için adını biz türettik. Profil bağlantın ve etiketlenmelerin bu adla görünür; şimdi kendin seç.':
      'Eftersom du loggade in med Google skapade vi ett namn åt dig. Din profillänk och omnämnanden använder det – välj ditt eget nu.',
  'Kontrol ediliyor...': 'Kontrollerar...',
  '@{} müsait': '@{} är ledigt',
  'Bu adı seç': 'Använd det här namnet',
  'Kullanıcı adın @{} oldu': 'Ditt användarnamn är nu @{}',
  'Sonradan Ayarlar\'dan değiştirebilirsin; her değişiklikten sonra 90 gün beklenir.':
      'Du kan ändra det senare i Inställningar; efter varje ändring väntar du 90 dagar.',
  'Değerlendirme': 'Betyg',
  'Değerlendirmeler ({})': 'Betyg ({})',
  'Henüz değerlendirme yok': 'Inga betyg ännu',
  'Puan verilen dizi ve filmler burada listelenir.':
      'Betygsatta serier och filmer visas här.',
  'Değerlendirmeler yüklenemedi': 'Betygen kunde inte läsas in',
  'Ayarla': 'Justera',
  'Filtre': 'Filter',
  'Çıkartma': 'Dekal',
  'Parlaklık': 'Ljusstyrka',
  'Kontrast': 'Kontrast',
  'Doygunluk': 'Mättnad',
  'Pozlama': 'Exponering',
  'Sıcaklık': 'Temperatur',
  ...
  'Açıkken profilini yalnız onayladığın takipçiler görür; yeni takipler sana istek olarak gelir':
      'När det är på ser bara följare du godkänt din profil; nya följningar kommer som förfrågningar',
  'İstek Gönderildi': 'Förfrågan skickad',
  'Bu hesap gizli': 'Det här kontot är privat',
  'İsteğin bekliyor; onaylanınca izlediklerini, yorumlarını ve listelerini görebilirsin.':
      'Din förfrågan väntar; när den godkänns ser du vad personen tittar på, kommentarer och listor.',
  'İzlediklerini, yorumlarını ve listelerini görmek için takip isteği gönder; onaylanınca profil açılır.':
      'Skicka en följförfrågan för att se vad personen tittar på, kommentarer och listor; profilen öppnas när den godkänns.',
  '@{} seni takip etmek istiyor': '@{} vill följa dig',
  '@{} takip isteğini kabul etti': '@{} godkände din följförfrågan',
  'Onayla': 'Godkänn',
  'Yeni liste oluştur': 'Skapa en ny lista',
  'Henüz listen yok.': 'Du har inga listor än.',
  'Telif hakkı onayı': 'Bekräftelse av upphovsrätt',
  'Yalnızca hakkına sahip olduğun ya da paylaşma izni aldığın videoları yükle. Telif hakkı ihlali içeren videolar kaldırılır ve hesap kapatılabilir.':
      'Ladda bara upp videor som du äger rättigheterna till eller har tillstånd att dela. Videor som gör intrång i upphovsrätten tas bort och kontot kan stängas.',
  'Onaylıyorum': 'Jag bekräftar',
  'Topluluk Kuralları': 'Communityregler',
  'Saldırgan, taciz edici, nefret içeren, cinsel, şiddet yüceltici ya da telif hakkı ihlali içeren içeriklere ve kötüye kullanıma sıfır tolerans gösterilir. Her yorum, gönderi, mesaj, liste ve kullanıcı uygulama içinden şikâyet edilebilir; istenmeyen kullanıcılar engellenebilir. Şikâyet edilen içerik 24 saat içinde incelenir; kural ihlalinde içerik kaldırılır ve hesap kapatılabilir.':
      'Nolltolerans mot kränkande, trakasserande, hatiskt, sexuellt, våldsförhärligande eller upphovsrättskränkande innehåll samt mot missbruk av tjänsten. Varje kommentar, inlägg, meddelande, lista och användare kan anmälas i appen; oönskade användare kan blockeras. Anmält innehåll granskas inom 24 timmar; vid regelbrott tas det bort och kontot kan stängas.',
  'Dosya verisi gerekli': 'Fildata krävs',
  'Geçerli bir ZIP, CSV ya da JSON dosyası değil':
      'Inte en giltig ZIP-, CSV- eller JSON-fil',
  'Dosya boş': 'Filen är tom',
  'Bu dosya tanınmadı: TV Time, Letterboxd ya da dizi.jpg dosyası yükle':
      'Filen kändes inte igen: ladda upp en fil från TV Time, Letterboxd eller dizi.jpg',
  ...
  'Takma ad': 'Smeknamn',
  'Bu adı yalnız sen görürsün': 'Bara du ser det här namnet',
  'Takma ad kaydedilemedi': 'Smeknamnet kunde inte sparas',
  'Tema karşı tarafa iletilemedi': 'Temat kunde inte skickas till den andra',
  'Seçtiğin tema karşı tarafta da görünür':
      'Temat du väljer syns även hos den andra',
  'Alıcı bir kez görebilir': 'Mottagaren kan se det en gång',
  'Açıldı': 'Öppnad',
  'Flaş': 'Blixt',
  'Fotoğraf çekilemedi': 'Kunde inte ta bild',
  'Galeri izni gerekli': 'Åtkomst till galleriet krävs',
  'Galeride medya yok': 'Inga medier i galleriet',
  'Galeriden seç': 'Välj från galleri',
  'Görmek için dokun': 'Tryck för att visa',
  'Konum': 'Plats',
  'Konum alınamadı': 'Kunde inte hämta platsen',
  'Konum izni gerekli': 'Platsbehörighet krävs',
  'Konum servisi kapalı': 'Platstjänster är av',
  'Konumum': 'Min plats',
  'Mesaj ekle...': 'Lägg till ett meddelande...',
  'Son fotoğrafların burada görünsün diye galerine erişim gerekir.':
      'Åtkomst till galleriet krävs för att visa dina senaste bilder här.',
  'Tek kullanımlık': 'Visa en gång',
  'Tek kullanımlık fotoğraf': 'Engångsbild',
  'Tek kullanımlık medya': 'Engångsmedia',
  'Tek kullanımlık video': 'Engångsvideo',
  'Tek kullanımlık yalnız tek fotoğraf veya videoda':
      'Visa en gång fungerar bara med en enda bild eller video',
  'Video kaydedilemedi': 'Kunde inte spara videon',
  'Video kaydı başlamadı': 'Videoinspelningen startade inte',
  'Çek': 'Ta',
  ...
  'Liste adı kaydedilemedi': 'Listnamnet kunde inte sparas',
  'Liste adı boş olamaz': 'Listnamnet får inte vara tomt',
  "dizi.jpg'de Bu Hafta En Çok İzlenen 10 Film":
      "Topp 10 filmer den här veckan på dizi.jpg",
  "dizi.jpg'de Bu Hafta En Çok İzlenen 10 Dizi":
      "Topp 10 serier den här veckan på dizi.jpg",
  "dizi.jpg'de Bu Ay En Çok İzlenen 10 Film":
      "Topp 10 filmer den här månaden på dizi.jpg",
  "dizi.jpg'de Bu Ay En Çok İzlenen 10 Dizi":
      "Topp 10 serier den här månaden på dizi.jpg",
  "dizi.jpg'de 2026'da En Çok İzlenen 50 Film":
      "Topp 50 filmer under 2026 på dizi.jpg",
  "dizi.jpg'de 2026'da En Çok İzlenen 50 Dizi":
      "Topp 50 serier under 2026 på dizi.jpg",
  "Bir süre gösterme": "Dölj ett tag",
  "Bu liste bir ay boyunca akışta görünmeyecek":
      "Den här listan visas inte i ditt flöde på en månad",
  "Liste gizlenemedi": "Listan kunde inte döljas",
};
