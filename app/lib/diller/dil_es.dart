...
const Map<String, String> cevirilerEs = {
  ...
  'Yapıştır': 'Pegar',
  'Panoda görsel yok': 'No hay ninguna imagen en el portapapeles',
  'Video bağlantısı': 'Enlace del video',
  'Odada aç': 'Abrir en la sala',
  'Doğrudan video adresi': 'Dirección directa de video',
  '{} videosu': 'Video de {}',
  'Başka video seç': 'Elegir otro video',
  'Bu video adresi açılamadı': 'No se pudo abrir esta dirección de video',
  'Oda sahibi henüz video seçmedi': 'El anfitrión aún no ha elegido un video',
  'Bir video bağlantısı yapıştır ya da dosya yükle':
      'Pega un enlace de video o sube un archivo',
  '{} bir video bağlantısı ekledi': '{} añadió un enlace de video',
  'Desteklenen siteler: {} · doğrudan video adresi (.mp4, .webm)':
      'Sitios compatibles: {} · dirección directa de video (.mp4, .webm)',
  'Bu adres desteklenmiyor. Desteklenen siteler: {} · doğrudan video adresi (.mp4, .webm)':
      'Esta dirección no es compatible. Sitios compatibles: {} · dirección directa de video (.mp4, .webm)',
  'Bu adres desteklenmiyor. {} bağlantısı ya da doğrudan bir video adresi (.mp4) yapıştır.':
      'Esta dirección no es compatible. Pega un enlace de {} o una dirección directa de video (.mp4).',
  '{} · doğrudan video adresi (.mp4) · ya da en fazla {} GB dosya':
      '{} · dirección directa de video (.mp4) · o un archivo de hasta {} GB',
  '{} · doğrudan video adresi': '{} · Dirección directa de video',
  'Bu canlı yayın biçimini (m3u8) tarayıcı oynatamaz; telefon uygulamasında açılır.':
      'El navegador no puede reproducir este formato en vivo (m3u8); se abre en la app del teléfono.',
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'Usamos el almacenamiento local para mantener tu sesión abierta y recordar preferencias como el idioma y el tema. En la web funciona Google Analytics para que podamos ver de forma agregada qué partes del sitio se usan; esta herramienta escribe su propia cookie de medición en tu navegador. No hay cookies de publicidad ni de segmentación.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'La información de series y películas proviene de TMDB, y la de proveedores de streaming de JustWatch. Las notificaciones push se entregan a través de Google Firebase, el tráfico web se mide con Google Analytics y el tráfico del sitio está protegido por Cloudflare. Estos servicios están sujetos a sus propias políticas de privacidad.',
  ...
  'dizi.jpg için en az 13 yaşında olmalısın.':
      'Debes tener al menos 13 años para usar dizi.jpg.',
  'En az 13 yaşında olmalısın': 'Debes tener al menos 13 años',
  ...
  'Klavye': 'Teclado',
  'Kullanıcı adını seç': 'Elige tu nombre de usuario',
  'Google ile giriş yaptığın için adını biz türettik. Profil bağlantın ve etiketlenmelerin bu adla görünür; şimdi kendin seç.':
      'Como iniciaste sesión con Google, generamos un nombre por ti. El enlace de tu perfil y las menciones lo usan; elige el tuyo ahora.',
  'Kontrol ediliyor...': 'Comprobando...',
  '@{} müsait': '@{} está disponible',
  'Bu adı seç': 'Usar este nombre',
  'Kullanıcı adın @{} oldu': 'Tu nombre de usuario ahora es @{}',
  'Sonradan Ayarlar\'dan değiştirebilirsin; her değişiklikten sonra 90 gün beklenir.':
      'Podrás cambiarlo después en Ajustes; tras cada cambio hay una espera de 90 días.',
  'Değerlendirme': 'Valoraciones',
  'Değerlendirmeler ({})': 'Valoraciones ({})',
  'Henüz değerlendirme yok': 'Aún no hay valoraciones',
  'Puan verilen dizi ve filmler burada listelenir.':
      'Las series y películas valoradas aparecen aquí.',
  'Değerlendirmeler yüklenemedi': 'No se pudieron cargar las valoraciones',
  'Ayarla': 'Ajustar',
  'Filtre': 'Filtro',
  'Çıkartma': 'Sticker',
  'Parlaklık': 'Brillo',
  ...
  'Sıcak': 'Cálido',
  'Soğuk': 'Frío',
  'Sinematik': 'Cinemático',
  'Retro': 'Retro',
  'Vintage': 'Vintage',
  'Siyah Beyaz': 'Blanco y negro',
  'Canlı': 'Vívido',
  'Analog': 'Analógico',
  'Kes': 'Recortar',
  'Hız': 'Velocidad',
  ...
  'Fotoğraf çek': 'Tomar foto',
  'Video çek': 'Grabar video',
  'Kolaj': 'Collage',
  'Düzen': 'Diseño',
  'Boşluk': 'Espaciado',
  'Köşe': 'Esquinas',
  'Kolaj oluşturulamadı': 'No se pudo crear el collage',
  'Kolaj en fazla {} fotoğraf alır': 'Un collage admite hasta {} fotos',
  'Yer değiştirmek için iki fotoğrafa dokun':
      'Toca dos fotos para intercambiarlas',
  'Eleştirmen': 'Crítica',
  'Seyirci': 'Público',
  "2027'de Vizyona Girecek Filmler": "Películas que se estrenan en 2027",
  "2027'de Başlayacak Diziler": "Series que empiezan en 2027",
  'Gizli hesap': 'Cuenta privada',
  'Açıkken profilini yalnız onayladığın takipçiler görür; yeni takipler sana istek olarak gelir':
      'Si está activa, solo los seguidores que apruebes ven tu perfil; los nuevos seguimientos te llegan como solicitudes',
  'İstek Gönderildi': 'Solicitado',
  'Bu hesap gizli': 'Esta cuenta es privada',
  'İsteğin bekliyor; onaylanınca izlediklerini, yorumlarını ve listelerini görebilirsin.':
      'Tu solicitud está pendiente; cuando la acepte podrás ver lo que ve, sus comentarios y sus listas.',
  'İzlediklerini, yorumlarını ve listelerini görmek için takip isteği gönder; onaylanınca profil açılır.':
      'Envía una solicitud de seguimiento para ver lo que ve, sus comentarios y sus listas; el perfil se abre al aceptarla.',
  '@{} seni takip etmek istiyor': '@{} quiere seguirte',
  '@{} takip isteğini kabul etti': '@{} aceptó tu solicitud de seguimiento',
  'Onayla': 'Aprobar',
  'Yeni liste oluştur': 'Crear una lista nueva',
  'Henüz listen yok.': 'Todavía no tienes listas.',
  'Telif hakkı onayı': 'Confirmación de derechos de autor',
  'Yalnızca hakkına sahip olduğun ya da paylaşma izni aldığın videoları yükle. Telif hakkı ihlali içeren videolar kaldırılır ve hesap kapatılabilir.':
      'Sube solo vídeos de los que tengas los derechos o permiso para compartir. Los vídeos que infrinjan derechos de autor se eliminan y la cuenta puede cerrarse.',
  'Onaylıyorum': 'Confirmo',
  ...
  'Sezonun bölümleri': 'Episodios de la temporada',
  ...
  'Galeriye kaydet': 'Guardar en la galería',
  'Galeriye kaydedildi': 'Guardado en la galería',
  'Galeriye kaydediliyor...': 'Guardando en la galería...',
  'Galeri izni verilmedi': 'Permiso de galería denegado',
  'Kaydedilemedi': 'No se pudo guardar',
  '{} medyayı galeriye kaydet': 'Guardar {} archivos en la galería',
  '{}/{} kaydedildi': '{}/{} guardados',
  'Hemen kaydol': 'Regístrate ahora',
  'Dizilerini bölüm bölüm işaretle, film listeni tut, puanla ve yorumla; arkadaşlarının ne izlediğini gör. Web ve mobilde.':
      'Marca tus series episodio a episodio, lleva tu lista de películas, puntúa y reseña, y mira qué ven tus amigos. En web y móvil.',
  '45 dilde. Web, Android ve iOS.': 'En 45 idiomas. Web, Android e iOS.',
  'Takma ad': 'Apodo',
  'Bu adı yalnız sen görürsün': 'Solo tú ves este nombre',
  'Takma ad kaydedilemedi': 'No se pudo guardar el apodo',
  ...
  'Bu mesaj silindi': 'Este mensaje fue eliminado',
  'Benden sil': 'Eliminar para mí',
  'Herkesten sil': 'Eliminar para todos',
  'Sohbeti sil': 'Eliminar chat',
  'Karşı taraftan da sil': 'Eliminar también para la otra persona',
  'Yalnız senden silinir': 'Se elimina solo para ti',
  '{} için de silinir': 'También se elimina para {}',
  'Bu sohbet senden silinecek. Geri alınamaz.':
      'Este chat se eliminará para ti. No se puede deshacer.',
  'Bu sohbet iki taraftan da silinecek. Geri alınamaz.':
      'Este chat se eliminará para ambos. No se puede deshacer.',
  'Sohbet silinemedi': 'No se pudo eliminar el chat',
  'İndiriliyor': 'Descargando',
  'İndirildi': 'Descargado',
  'Dosya indirilemedi': 'No se pudo descargar el archivo',
  'Bu dosyayı açacak uygulama yok': 'Ninguna app puede abrir este archivo',
  'Dosyanın yalnız başı gösteriliyor': 'Solo se muestra el inicio del archivo',
  // Kanon listeleri + çark seçeneği (kanon, 16 Eyl 2026)
  'Ölmeden İzlenmesi Gereken 100 Film': '100 películas que ver antes de morir',
  'Ölmeden İzlenmesi Gereken 250 Film': '250 películas que ver antes de morir',
  'Ölmeden İzlenmesi Gereken 500 Film': '500 películas que ver antes de morir',
  'Ölmeden İzlenmesi Gereken 1000 Film':
      '1000 películas que ver antes de morir',
  'Ölmeden İzlenmesi Gereken 10 Dizi': '10 series que ver antes de morir',
  'Ölmeden İzlenmesi Gereken 25 Dizi': '25 series que ver antes de morir',
  'Ölmeden İzlenmesi Gereken 50 Dizi': '50 series que ver antes de morir',
  'Ölmeden İzlenmesi Gereken 100 Dizi': '100 series que ver antes de morir',
