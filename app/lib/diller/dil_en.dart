...
const Map<String, String> cevirilerEn = {
  ...
  'Bu cihazdan yeni hesap açılamıyor': 'Can\'t create a new account from this device',
  'Geçerli e-posta, kullanıcı adı ve en az 6 karakter şifre gerekli': 'Valid email, username and a password of at least 6 characters are required',
  'Geçerli e-posta ve en az 6 karakter şifre gerekli': 'Valid email and a password of at least 6 characters are required',
  'Kullanıcı adı 3-20 karakter; küçük harf, rakam, nokta, tire ve alt çizgi kullanılabilir (başta/sonda nokta-tire olamaz)': 'Username must be 3–20 characters; lowercase letters, digits, dots, hyphens and underscores (no leading/trailing dot or hyphen)',
  ...
  'İki adımlı doğrulama zaten bu durumda': 'Two-step verification is already in this state',
  'Kod yanlış': 'Wrong code',
  'Kodun süresi doldu': 'Code expired',
  'Kullanıcının e-postası yok (misafir hesap)': 'This user has no email (guest account)',
  ...
  'Ad en fazla 60, açıklama 300 karakter olabilir': 'Name can be 60 characters, description 300',
  'Liste bulunamadı': 'List not found',
  'Değiştirilecek tercih yok': 'Nothing to update',
  'İnceleme en fazla 2000 karakter olabilir': 'Review can be at most 2000 characters',
  'Önce içeriği "bitirdim" olarak işaretle': 'Mark the title as finished first',
  'Önce kişiyi favorile': 'Favorite the person first',
  'Bölüm yorumu için sezon ve bolum birlikte gerekli': 'Season and episode are both required for an episode comment',
  ...
  'Başlık ve metin gerekli (en az 2 karakter)': 'Title and text are required (at least 2 characters)',
  'Kendine mesaj gönderemezsin': 'You can\'t message yourself',
  'Mesaj en fazla 2000 karakter olabilir': 'Message can be at most 2000 characters',
  ...
  'Yalnız sana gelen mesajı şikayet edebilirsin': 'You can only report a message sent to you',
  'Sebep gerekli': 'Reason is required',
  'İtiraz edilecek aktif bir ceza yok': 'There is no active penalty to appeal',
  'Zaten incelenmeyi bekleyen bir itirazın var': 'You already have an appeal pending review',
  'Bu ceza için itirazın zaten incelendi': 'Your appeal for this penalty was already reviewed',
  'Medya bağlantısının süresi dolmuş': 'Media link expired',
  'Bu medya için imzalı bağlantı gerekli': 'A signed link is required for this media',
  'Arama hizmeti yeniden başlatılıyor, birazdan tekrar dene': 'Calling service is restarting, try again in a bit',
};
