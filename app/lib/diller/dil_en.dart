...
const Map<String, String> cevirilerEn = {
  'dizi.jpg uygulamasını indir': 'Download the dizi.jpg app',
  'Daha hızlı gezinme, bildirimler ve tam ekran deneyim uygulamada.':
      'Faster browsing, notifications and a full-screen experience are in the app.',
  'Uygulamayı indir': 'Download the app',
  'Tarayıcıda devam et': 'Continue in browser',
  ...
  "Tüm verini (izleme, puan, yorum, liste) TV Time uyumlu ZIP olarak al ya da TV Time / Letterboxd ZIP'ini içe aktar.":
      'Export all your data (watches, ratings, comments, lists) as a TV Time-compatible ZIP, or import a TV Time / Letterboxd ZIP.',
  ...
  '• {} kitaplık kaydı': '• {} library entries',
  '• {} favori': '• {} favorites',
  ...
  '{} ve {} yorumunu beğendi': '{} and {} liked your comment',
  '{} ve {} kişi yorumunu beğendi': '{} and {} others liked your comment',
  ...
  'yazıyor...': 'typing...',
  'ses kaydediyor...': 'recording audio...',
  ...
  'Altyazıyı aç': 'Turn on subtitles',
  'Altyazıyı kapat': 'Turn off subtitles',
  '10 saniye ileri': 'Skip forward 10 seconds',
  '10 saniye geri': 'Skip back 10 seconds',
  'Duraklat': 'Pause',
  ...
  'Apple girişi başarısız': 'Apple sign-in failed',
  ...
  'Sunucuda geçici olarak yer yok, birazdan tekrar dene':
      'No space on the server right now, try again shortly',
  'Devam eden yapımlar ({})': 'Ongoing productions ({})',
  'Diziler ({})': 'Series ({})',
  'Filmler ({})': 'Movies ({})',
  'Tüm yapımlar': 'All productions',
  'Medya alanın doldu; yer açmak için eski yüklemelerini sil':
      'Your media storage is full; delete old uploads to free up space',
  ...
  'dizi.jpg için en az 13 yaşında olmalısın.':
      'You must be at least 13 years old to use dizi.jpg.',
  'En az 13 yaşında olmalısın': 'You must be at least 13 years old',
  ...
  'TMDB puanı': 'TMDB rating',
  'Yapım yılı': 'Release year',
  'dizi.jpg puanı': 'dizi.jpg rating',
  'İzlenme': 'Views',
  'Yorum sayısı': 'Comment count',
  'Tüm raflara uygulanır': 'Applies to all shelves',
  'En popüler {} yapım arasında sıralandı':
      'Sorted among the {} most popular titles',
  'Altyazı görünümü': 'Subtitle appearance',
  'Renk, yazı tipi, boyut, ayrıt ve opaklık':
      'Color, font, size, edge and opacity',
  'Bu bir örnek altyazıdır.': 'This is a sample subtitle.',
  'Ayar değiştikçe önizleme anında güncellenir.':
      'The preview updates instantly as you change settings.',
  'Yazı biçimi': 'Text style',
  'Yazı rengi': 'Text color',
  'Yazı opaklığı': 'Text opacity',
  'Yazı tipi': 'Font',
  'Yazı boyutu': 'Text size',
  'Karakter ayrıtı': 'Character edge',
  'Ayrıt türü': 'Edge type',
  'Ayrıt rengi': 'Edge color',
  'Yok': 'None',
  'Dış çizgi': 'Outline',
  'Gölge': 'Drop shadow',
  'Kabartma': 'Raised',
  ...
  'Arka plan opaklığı': 'Background opacity',
  'Arka plan yazının hemen arkasındaki dolgudur; pencere ise tüm altyazı bloğunun arkasındaki daha geniş yüzey.':
      'The background is the fill right behind the text; the window is the wider surface behind the whole subtitle block.',
  'Pencere': 'Window',
  'Pencere rengi': 'Window color',
  'Pencere opaklığı': 'Window opacity',
  'Altyazı görünümü sıfırlansın mı?': 'Reset subtitle appearance?',
  'Renk, yazı tipi, boyut, ayrıt ve opaklık ayarları varsayılana döner.':
      'Color, font, size, edge and opacity settings will return to their defaults.',
  'Altyazı görünümü varsayılana döndü': 'Subtitle appearance reset to defaults',
  '{} indiriliyor…': 'Downloading {}…',
  'Seçince indirilir': 'Downloads when selected',
  'Yazı tipi indirilemedi. Varsayılan yazı tipiyle gösteriliyor.':
      'Font could not be downloaded. Showing with the default font.',
  'Beyaz': 'White',
  'Siyah': 'Black',
  'Kırmızı': 'Red',
  'Yeşil': 'Green',
  ...
  'Bütçe': 'Budget',
  'dizi.jpg AI özeti': 'dizi.jpg AI summary',
  'Daha fazlasını gör': 'See more',
  'Yıldız sistemi': 'Star system',
  '{} yıldız üzerinden': 'Out of {} stars',
  'Önizleme': 'Preview',
  'dokununca açılır': 'opens on tap',
  ...
  'Dizi veya film seç (zorunlu)': 'Choose a show or movie (required)',
  'Bölüm seç (isteğe bağlı)': 'Choose an episode (optional)',
  ...
  'Sezonlar yüklenemedi.': 'Seasons could not be loaded.',
  'Bu dizide bölüm bilgisi yok.': 'No episode information for this show.',
  ...
  'Dizinin kendisi': 'The show itself',
  'Sezon ya da bölüm seçme': 'No season or episode',
  'Tüm {}. sezon': 'All of season {}',
  'Bölüm seçme': 'No episode',
  'En fazla {} yapım ekleyebilirsin.': 'You can add up to {} titles.',
  'Bu zaten ekli.': 'Already added.',
  'Dizi, film, oyuncu ya da yönetmen etiketle — gönderin onların sayfasında da görünür.':
      'Tag a show, movie, actor or director — your post will also appear on their page.',
  'Etiket ekle': 'Add tag',
  'Dizi, film, oyuncu ya da yönetmen etiketle':
      'Tag a show, movie, actor or director',
  'Gönderiden vazgeç': 'Discard post',
  'Yazdıkların kaydedilmeyecek.': 'What you wrote will not be saved.',
  'Yazmaya devam et': 'Keep writing',
  ...
  'ya da': 'or',
  'Google ile doğrula': 'Verify with Google',
  'Apple ile doğrula': 'Verify with Apple',
  'Hesabını Google ya da Apple ile açtıysan şifren yoktur; kimliğini o hesapla doğrula.':
      'If you created your account with Google or Apple, you have no password; verify your identity with that account.',
  'Hesabını Google ile açtıysan şifren yoktur; kimliğini Google ile doğrula.':
      'If you created your account with Google you have no password; verify your identity with Google.',
  'Google doğrulaması bu hesapla eşleşmedi':
      'Google verification did not match this account',
  'Bu hesap Google ile açıldı; doğrulamak için Google ile giriş yap':
      'This account was created with Google; sign in with Google to verify',
  // --- 31 Agu 2026: kitaplik paylasimi + reels ceviri + sohbet detayi ---
  'Bu liste gizli': 'This list is private',
  'Bu kullanıcı izleme listelerini gizli tutmayı tercih ediyor.':
      'This user prefers to keep their watch lists private.',
  'Bu listede henüz içerik yok': 'No titles in this list yet',
  'Otomatik çeviri': 'Automatic translation',
  'Otomatik çeviri açıldı': 'Automatic translation turned on',
  'Otomatik çeviri kapatıldı': 'Automatic translation turned off',
  'Sohbet sessize alındı': 'Chat muted',
  'Sessize alma kaldırıldı': 'Unmuted',
  'Tema özelleştir': 'Customize theme',
  'Sohbette ara': 'Search in chat',
  'Mesajlarda ara...': 'Search messages...',
  'Sonuç yok': 'No results',
  'Profili gör': 'View profile',
  'Medya ve dosyalar': 'Media and files',
  'Henüz medya yok': 'No media yet',
  'Varsayılan': 'Default',
  'Mor': 'Purple',
  'Pembe': 'Pink',
  'Turuncu': 'Orange',
  'Orijinal metin gösteriliyor': 'Showing original text',
  ...
  'Temizle': 'Clear',
  'Oyuncu': 'Actor',
  'Böyle bir oda yok': 'No such room',
  'Bu oda kapandı': 'This room has closed',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'You need an invite or a room code to join',
  'Oda dolu': 'Room is full',
  'Bu odaya giremezsin': "You can't join this room",
  'Bu odanın üyesi değilsin': "You're not a member of this room",
  'Bunu yalnız oda sahibi yapabilir': 'Only the room host can do that',
  'Oda sahibi odayı kapatmalı': 'The host has to close the room',
  'Zaten açık bir odan var': 'You already have an open room',
  'Oda kodu 6 karakter olmalı': 'Room code must be 6 characters',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      "Guest accounts can't open watch rooms. Create an account to open one.",
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'You can only invite people who follow you back',
  'Video en fazla {} GB olabilir': 'Video can be at most {} GB',
  'Yalnızca MP4 veya WebM izlenebilir': 'Only MP4 or WebM can be played',
  '{} odaya katıldı': '{} joined the room',
  '{} odadan ayrıldı': '{} left the room',
  '{} bir video yükledi': '{} uploaded a video',
  'bitti': 'done',
  '{} sn': '{}s',
  'Birlikte izle': 'Watch together',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Upload a video, invite your friends, watch at the same time.',
  'Henüz bir odan ya da davetin yok.':
      "You don't have a room or an invite yet.",
  'Odaya katıl': 'Join a room',
  'Oda kodu': 'Room code',
  'Katıl': 'Join',
  'Oda oluştur': 'Create room',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'Rooms close on their own after 12 hours and the video is deleted.',
  'Odam': 'My room',
  '@{} odası': "@{}'s room",
  'Seni davet etti': 'Invited you',
  '{} kişi': '{} people',
  'Video yok': 'No video',
  '{} kaldı': '{} left',
  'Davet': 'Invite',
  '@{} davet edildi': '@{} invited',
  'Oda kodu kopyalandı': 'Room code copied',
  'Odayı kapat': 'Close room',
  'Odadan ayrıl': 'Leave room',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      "The room will close and the video will be deleted. This can't be undone.",
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      "You'll leave the room. You can come back with the code or an invite.",
  'Ayrıl': 'Leave',
  'İzleme odası': 'Watch room',
  'Odalar 12 saat sonra kendiliğinden kapanır.':
      'Rooms close on their own after 12 hours.',
  '{} kişi · {} kaldı': '{} people · {} left',
  'Davet et': 'Invite',
  'Bir video yükle, izlemeye başlayın': 'Upload a video and start watching',
  'Oda sahibi henüz video yüklemedi': "The host hasn't uploaded a video yet",
  'Video yükle': 'Upload video',
  'En fazla {} GB · MP4 veya WebM': 'Up to {} GB · MP4 or WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'Resuming upload · {}/{} MB',
  'Yükleniyor · {}/{} MB': 'Uploading · {}/{} MB',
  'Videoyu değiştir': 'Change video',
  'Oda sahibiyle eşleniyor': 'Syncing with the host',
  'Sohbet boş': 'Chat is empty',
  'İzlerken buradan konuşabilirsiniz.': 'You can talk here while you watch.',
  'oda sahibi': 'host',
  'davet bekliyor': 'invite pending',
  'çevrimdışı': 'offline',
  'Mesaj yaz...': 'Write a message...',
  'Oda kodunu kopyala': 'Copy room code',
  'Oda kodu {} — kopyala': 'Room code {} — copy',
  'Arkadaşını davet et': 'Invite a friend',
  'kullanıcı adı': 'username',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'You can only invite people who follow you back.',
  'Oda açılamadı': 'Room could not be opened',
  'Tam ekrandan çık': 'Exit fullscreen',
  'Sohbeti gizle': 'Hide chat',
  'Sohbeti göster': 'Show chat',
  'Fragman': 'Trailer',
  'Tekrar oynat': 'Replay',
  ...
  'Yetkili': 'Moderator',
  'Kontrolü ver': 'Give control',
  'Kontrolü al': 'Take control back',
  'Videoyu oynatıp durdurabilir ve değiştirebilir.':
      'Can play, pause and change the video.',
  'Artık videoyu yönetemez.': 'Can no longer manage the video.',
  'Bunu oda sahibi ve yetki verdiği kişiler yapabilir':
      'Only the host and the people they trust can do that',
  'Kendi yetkini değiştiremezsin': "You can't change your own permissions",
  'Geçersiz yetki': 'Invalid permission',
  '{} artık videoyu yönetebilir': '{} can now manage the video',
  '{} kontrolü bıraktı': '{} no longer has control',
  'Kişi ara...': 'Search people...',
  'Karşılıklı takipleştiğin kimse yok': 'Nobody follows you back yet',
  'Böyle bir kullanıcı yok': 'No such user',
  'Oda kodunu paylaşarak da davet edebilirsin.':
      'You can also invite by sharing the room code.',
  'Karşılıklı takipleşmiyorsunuz': "You don't follow each other",
  'Odada': 'In the room',
  'Davet edildi': 'Invited',
  'Aşk': 'Love',
  'Arkadaşlar': 'Friends',
  ...
  'Klavye': 'Keyboard',
  'Kullanıcı adını seç': 'Choose your username',
  'Google ile giriş yaptığın için adını biz türettik. Profil bağlantın ve etiketlenmelerin bu adla görünür; şimdi kendin seç.':
      'Since you signed in with Google, we generated a username for you. Your profile link and mentions use it — pick your own now.',
  'Kontrol ediliyor...': 'Checking...',
  '@{} müsait': '@{} is available',
  'Bu adı seç': 'Use this name',
  'Kullanıcı adın @{} oldu': 'Your username is now @{}',
  'Sonradan Ayarlar\'dan değiştirebilirsin; her değişiklikten sonra 90 gün beklenir.':
      'You can change it later in Settings; each change is followed by a 90-day wait.',
  'Değerlendirme': 'Ratings',
  'Değerlendirmeler ({})': 'Ratings ({})',
  'Henüz değerlendirme yok': 'No ratings yet',
  'Puan verilen dizi ve filmler burada listelenir.':
      'Rated shows and movies are listed here.',
  'Değerlendirmeler yüklenemedi': 'Couldn\'t load ratings',
  'Ayarla': 'Adjust',
  'Filtre': 'Filter',
  'Çıkartma': 'Sticker',
  ...
  'Eleştirmen': 'Critics',
  'Seyirci': 'Audience',
  "2027'de Vizyona Girecek Filmler": "Movies Coming in 2027",
  "2027'de Başlayacak Diziler": "Shows Starting in 2027",
  'Gizli hesap': 'Private account',
  'Açıkken profilini yalnız onayladığın takipçiler görür; yeni takipler sana istek olarak gelir':
      'When on, only followers you approve can see your profile; new follows come to you as requests',
  'İstek Gönderildi': 'Requested',
  'Bu hesap gizli': 'This account is private',
  'İsteğin bekliyor; onaylanınca izlediklerini, yorumlarını ve listelerini görebilirsin.':
      'Your request is pending; once approved you can see what they watch, their comments and lists.',
  'İzlediklerini, yorumlarını ve listelerini görmek için takip isteği gönder; onaylanınca profil açılır.':
      'Send a follow request to see what they watch, their comments and lists; the profile opens once approved.',
  '@{} seni takip etmek istiyor': '@{} wants to follow you',
  '@{} takip isteğini kabul etti': '@{} accepted your follow request',
  'Onayla': 'Approve',
  'Yeni liste oluştur': 'Create a new list',
  'Henüz listen yok.': 'You don\'t have any lists yet.',
  'Telif hakkı onayı': 'Copyright confirmation',
  'Yalnızca hakkına sahip olduğun ya da paylaşma izni aldığın videoları yükle. Telif hakkı ihlali içeren videolar kaldırılır ve hesap kapatılabilir.':
      'Only upload videos you own or have permission to share. Videos that infringe copyright are removed and the account may be closed.',
  ...
  'Sezonun bölümleri': 'Episodes this season',
  ...
  'Alıcı bir kez görebilir': 'The recipient can view it once',
  'Açıldı': 'Opened',
  'Flaş': 'Flash',
  'Fotoğraf çekilemedi': 'Could not take photo',
  'Galeri izni gerekli': 'Gallery access needed',
  'Galeride medya yok': 'No media in gallery',
  'Galeriden seç': 'Pick from gallery',
  'Görmek için dokun': 'Tap to view',
  'Konum': 'Location',
  'Konum alınamadı': 'Could not get location',
  'Konum izni gerekli': 'Location permission needed',
  'Konum servisi kapalı': 'Location services are off',
  'Konumum': 'My location',
  'Mesaj ekle...': 'Add a message...',
  'Son fotoğrafların burada görünsün diye galerine erişim gerekir.':
      'Gallery access is needed to show your recent photos here.',
  'Tek kullanımlık': 'View once',
  'Tek kullanımlık fotoğraf': 'View-once photo',
  'Tek kullanımlık medya': 'View-once media',
  'Tek kullanımlık video': 'View-once video',
  'Tek kullanımlık yalnız tek fotoğraf veya videoda':
      'View once works only with a single photo or video',
  'Video kaydedilemedi': 'Could not save video',
  'Video kaydı başlamadı': 'Video recording did not start',
  'Çek': 'Capture',
  'Çekmek için dokun, video için basılı tut': 'Tap to shoot, hold for video',
  'İzin ver': 'Allow',
  'az önce': 'just now',
  '{} dk önce': '{} min ago',
  '{} dk önce~tekil': '{} min ago',
  '{} saat önce': '{} hours ago',
  '{} saat önce~tekil': '{} hour ago',
  '{} gün önce': '{} days ago',
  '{} gün önce~tekil': '{} day ago',
  '{} hafta önce': '{} weeks ago',
  '{} hafta önce~tekil': '{} week ago',
  // Mesaj/sohbet silme + belge indirme (16 Eyl 2026)
  'Bu mesaj silindi': 'This message was deleted',
  'Benden sil': 'Delete for me',
  'Herkesten sil': 'Delete for everyone',
  'Sohbeti sil': 'Delete chat',
  'Karşı taraftan da sil': 'Delete for the other person too',
  'Yalnız senden silinir': 'Deleted only for you',
  '{} için de silinir': 'Also deleted for {}',
  'Bu sohbet senden silinecek. Geri alınamaz.':
      'This chat will be deleted for you. This cannot be undone.',
  'Bu sohbet iki taraftan da silinecek. Geri alınamaz.':
      'This chat will be deleted for both sides. This cannot be undone.',
  'Sohbet silinemedi': 'Chat couldn\'t be deleted',
  'İndiriliyor': 'Downloading',
  'İndirildi': 'Downloaded',
  'Dosya indirilemedi': 'File couldn\'t be downloaded',
