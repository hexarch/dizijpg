...
const Map<String, String> cevirilerRo = {
  ...
  "Tüm verini (izleme, puan, yorum, liste) TV Time uyumlu ZIP olarak al ya da TV Time / Letterboxd ZIP'ini içe aktar.":
      'Descarcă-ți toate datele (vizionări, note, comentarii, liste) ca ZIP compatibil cu TV Time sau importă un ZIP din TV Time / Letterboxd.',
  ...
  '• {} kitaplık kaydı': '• {} intrări în bibliotecă',
  '• {} favori': '• {} favorite',
  ...
  'Yanıtla': 'Răspunde',
  '@{} kullanıcısına yanıt veriyorsun': 'Răspuns pentru @{}',
  ...
  '{} ve {} yorumunu beğendi': '{} și {} au apreciat comentariul tău',
  '{} ve {} kişi yorumunu beğendi':
      '{} și încă {} persoane au apreciat comentariul tău',
  ...
  'yazıyor...': 'scrie...',
  'ses kaydediyor...': 'înregistrează audio...',
  ...
  'İçerik': 'Conținut',
  'çevrimiçi': 'online',
  'son görülme {} dk önce': 'online acum {} min',
  'son görülme {} saat önce': 'online acum {} h',
  'son görülme {} gün önce': 'online acum {} z',
  ...
  'Altyazıyı aç': 'Activează subtitrările',
  'Altyazıyı kapat': 'Dezactivează subtitrările',
  '10 saniye ileri': 'Înainte 10 secunde',
  '10 saniye geri': 'Înapoi 10 secunde',
  'Duraklat': 'Pauză',
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'Folosim stocarea locală pentru a te menține conectat și pentru a reține preferințe precum limba și tema. Pe web rulează Google Analytics, ca să putem vedea în mod agregat care părți ale site-ului sunt folosite; acest instrument scrie în browserul tău propriul cookie de măsurare. Nu există cookie-uri de publicitate sau de targetare.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'Informațiile despre seriale și filme provin de la TMDB, iar cele despre furnizorii de streaming de la JustWatch. Notificările push sunt livrate prin Google Firebase, traficul web este măsurat cu Google Analytics, iar traficul site-ului este protejat de Cloudflare. Aceste servicii sunt supuse propriilor politici de confidențialitate.',
  ...
  'Bu gönderiyi ilk beğenen sen ol': 'Fii prima persoană care apreciază',
  ...
  'İlk kullanıcılarımızdan biri. Geri bildirimleriyle uygulamanın bugün olduğu hale gelmesine katkı sağladı.':
      'Printre primii noștri utilizatori. Feedbackul a ajutat aplicația să devină ceea ce este astăzi.',
  ...
  'Giriş gerekli': 'Autentificare necesară',
  'Geçersiz oturum': 'Sesiune nevalidă',
  ...
  'Bu e-posta veya kullanıcı adı zaten kayıtlı':
      'Acest e-mail sau utilizator e deja folosit',
  'Google doğrulaması başarısız': 'Verificarea Google a eșuat',
  'Kod geçersiz veya süresi dolmuş': 'Cod invalid sau expirat',
  'Bu kullanıcıyla mesajlaşamazsın': 'Nu poți scrie acestui utilizator',
  'Kendini takip edemezsin': 'Nu te poți urmări pe tine',
  'Bu kullanıcıyı takip edemezsin': 'Nu poți urmări acest utilizator',
  'Kendini engelleyemezsin': 'Nu te poți bloca pe tine',
  'Yorum 1-1000 karakter olmalı':
      'Comentariul trebuie să aibă 1–1000 de caractere',
  'Boş mesaj gönderilemez': 'Nu poți trimite un mesaj gol',
  'Yorum bulunamadı': 'Comentariul nu a fost găsit',
  'Şifre hatalı': 'Parolă greșită',
  'Şifre en az 6 karakter olmalı':
      'Parola trebuie să aibă cel puțin 6 caractere',
  'Yalnızca GIF, PNG, JPEG veya WebP yüklenebilir':
      'Poți încărca doar GIF, PNG, JPEG sau WebP',
  'Desteklenen türler: GIF, PNG, JPEG, WebP, MP4, WebM, ses':
      'Tipuri acceptate: GIF, PNG, JPEG, WebP, MP4, WebM, audio',
  'Geçerli bir ZIP dosyası değil': 'Nu este un ZIP valid',
  'Verilerini e-postayla almak için önce hesabına e-posta bağlamalısın':
      'Ca să-ți primești datele pe e-mail, leagă mai întâi o adresă',
  'Bu içerikte izleme kaydın var. "İzleyeceğim" demek için önce izleme işaretlerin silinmeli.':
      'Ai deja marcaje de vizionare. Ca să pui „O să vizionez", trebuie șterse mai întâi.',
  'Arama şu anda kapalı': 'Apelurile sunt oprite momentan',
  'Misafir hesaplar arama ayarlarını açamaz; hesap oluşturunca kullanabilirsin':
      'Conturile oaspete nu pot porni apelurile; creează un cont',
  ...
  'dizi.jpg için en az 13 yaşında olmalısın.':
      'Trebuie să ai cel puțin 13 ani pentru a folosi dizi.jpg.',
  'En az 13 yaşında olmalısın': 'Trebuie să ai cel puțin 13 ani',
  ...
  'Bütçe': 'Buget',
  'dizi.jpg AI özeti': 'Rezumat IA dizi.jpg',
  'Daha fazlasını gör': 'Vezi mai mult',
  'Yıldız sistemi': 'Sistem de stele',
  '{} yıldız üzerinden': 'Din {} stele',
  'Önizleme': 'Previzualizare',
  'dokununca açılır': 'se deschide la atingere',
  'Bir azalt': 'Scade cu unu',
  'Bir artır': 'Crește cu unu',
  'Ölçek kaydedilemedi': 'Scara nu a putut fi salvată',
  'Ölçeği değiştirmek puanlarını silmez; aynı puanlar yeni ölçekte gösterilir.':
      'Schimbarea scării nu îți șterge notele; aceleași note apar pe noua scară.',
  ...
  'Dizi veya film seç (zorunlu)': 'Alege un serial sau film (obligatoriu)',
  'Bölüm seç (isteğe bağlı)': 'Alege un episod (opțional)',
  '{}. sezon {}. bölüm': 'Sezonul {}, episodul {}',
  ...
  'Temizle': 'Șterge',
  'Oyuncu': 'Actor',
  'Böyle bir oda yok': 'Nu există o astfel de cameră',
  'Bu oda kapandı': 'Această cameră s-a închis',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'Ai nevoie de o invitație sau de un cod de cameră',
  'Oda dolu': 'Camera este plină',
  'Bu odaya giremezsin': 'Nu poți intra în această cameră',
  'Bu odanın üyesi değilsin': 'Nu ești membru al acestei camere',
  'Bunu yalnız oda sahibi yapabilir': 'Doar gazda camerei poate face asta',
  'Oda sahibi odayı kapatmalı': 'Gazda trebuie să închidă camera',
  'Zaten açık bir odan var': 'Ai deja o cameră deschisă',
  'Oda kodu 6 karakter olmalı': 'Codul camerei trebuie să aibă 6 caractere',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'Conturile de invitat nu pot deschide camere. Creează un cont ca să deschizi una.',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'Poți invita doar persoanele care te urmăresc înapoi',
  'Video en fazla {} GB olabilir': 'Videoclipul poate avea cel mult {} GB',
  'Yalnızca MP4 veya WebM izlenebilir': 'Se pot reda doar MP4 sau WebM',
  '{} odaya katıldı': '{} a intrat în cameră',
  '{} odadan ayrıldı': '{} a ieșit din cameră',
  '{} bir video yükledi': '{} a încărcat un videoclip',
  'bitti': 's-a terminat',
  '{} sn': '{} s',
  'Birlikte izle': 'Priviți împreună',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Încarcă un videoclip, invită-ți prietenii și priviți în același timp.',
  'Henüz bir odan ya da davetin yok.': 'Încă nu ai o cameră sau o invitație.',
  'Odaya katıl': 'Intră într-o cameră',
  'Oda kodu': 'Cod cameră',
  'Katıl': 'Intră',
  'Oda oluştur': 'Creează cameră',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'Camerele se închid singure după 12 ore, iar videoclipul se șterge.',
  'Odam': 'Camera mea',
  '@{} odası': 'Camera lui @{}',
  'Seni davet etti': 'Te-a invitat',
  '{} kişi': '{} persoane',
  'Video yok': 'Fără videoclip',
  '{} kaldı': 'Au rămas {}',
  'Davet': 'Invitație',
  '@{} davet edildi': '@{} invitat',
  'Oda kodu kopyalandı': 'Cod cameră copiat',
  'Odayı kapat': 'Închide camera',
  'Odadan ayrıl': 'Ieși din cameră',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'Camera se va închide și videoclipul va fi șters. Nu se poate anula.',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'Vei ieși din cameră. Poți reveni cu codul sau cu o invitație.',
  'Ayrıl': 'Ieși',
  'İzleme odası': 'Cameră de vizionare',
  'Odalar 12 saat sonra kendiliğinden kapanır.':
      'Camerele se închid singure după 12 ore.',
  '{} kişi · {} kaldı': '{} persoane · au rămas {}',
  'Davet et': 'Invită',
  'Bir video yükle, izlemeye başlayın':
      'Încarcă un videoclip și începeți vizionarea',
  'Oda sahibi henüz video yüklemedi': 'Gazda nu a încărcat încă un videoclip',
  'Video yükle': 'Încarcă videoclip',
  'En fazla {} GB · MP4 veya WebM': 'Până la {} GB · MP4 sau WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'Se reia încărcarea · {}/{} MB',
  'Yükleniyor · {}/{} MB': 'Se încarcă · {}/{} MB',
  'Videoyu değiştir': 'Schimbă videoclipul',
  'Oda sahibiyle eşleniyor': 'Se sincronizează cu gazda',
  'Sohbet boş': 'Chatul este gol',
  'İzlerken buradan konuşabilirsiniz.': 'Aici puteți vorbi în timp ce priviți.',
  'oda sahibi': 'gazdă',
  'davet bekliyor': 'invitație în așteptare',
  'çevrimdışı': 'offline',
  'Mesaj yaz...': 'Scrie un mesaj...',
  'Oda kodunu kopyala': 'Copiază codul camerei',
  'Oda kodu {} — kopyala': 'Cod cameră {} — copiază',
  'Arkadaşını davet et': 'Invită un prieten',
  'kullanıcı adı': 'nume de utilizator',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'Poți invita doar persoanele care te urmăresc înapoi.',
  ...
  'Filtre': 'Filtru',
  'Çıkartma': 'Sticker',
  'Parlaklık': 'Luminozitate',
  'Kontrast': 'Contrast',
  'Doygunluk': 'Saturație',
  'Pozlama': 'Expunere',
  'Sıcaklık': 'Temperatură',
  'Renk tonu': 'Nuanță',
  'Ton': 'Tentă',
  'Soluk': 'Estompare',
  'Orijinal': 'Original',
