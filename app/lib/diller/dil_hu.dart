...
const Map<String, String> cevirilerHu = {
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'A helyi tárolót arra használjuk, hogy bejelentkezve maradj, és hogy megjegyezzük a beállításaidat, például a nyelvet és a témát. A weben Google Analytics fut, hogy összesítve láthassuk, az oldal mely részeit használják; ez az eszköz saját mérési sütit ír a böngésződbe. Reklám- vagy hirdetéscélzó süti nincs.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'A sorozat- és filmadatok a TMDB-től, a streamingszolgáltatókra vonatkozó adatok a JustWatch-tól származnak. A push értesítéseket a Google Firebase továbbítja, a webes forgalmat a Google Analytics méri, az oldal forgalmát pedig a Cloudflare védi. Ezekre a szolgáltatásokra a saját adatvédelmi szabályzatuk érvényes.',
  ...
  'Temizle': 'Törlés',
  'Oyuncu': 'Színész',
  'Böyle bir oda yok': 'Nincs ilyen szoba',
  'Bu oda kapandı': 'Ez a szoba bezárt',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'Meghívó vagy szobakód kell a belépéshez',
  'Oda dolu': 'A szoba tele van',
  'Bu odaya giremezsin': 'Nem tudsz belépni ebbe a szobába',
  'Bu odanın üyesi değilsin': 'Nem vagy tagja ennek a szobának',
  'Bunu yalnız oda sahibi yapabilir': 'Ezt csak a szoba gazdája teheti meg',
  'Oda sahibi odayı kapatmalı': 'A szobát a gazdának kell bezárnia',
  'Zaten açık bir odan var': 'Már van egy nyitott szobád',
  'Oda kodu 6 karakter olmalı': 'A szobakód 6 karakter legyen',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'Vendégfiókok nem nyithatnak szobát. Hozz létre fiókot, és nyithatsz egyet.',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'Csak azokat hívhatod meg, akik vissza is követnek',
  'Video en fazla {} GB olabilir': 'A videó legfeljebb {} GB lehet',
  'Yalnızca MP4 veya WebM izlenebilir': 'Csak MP4 vagy WebM játszható le',
  '{} odaya katıldı': '{} belépett a szobába',
  '{} odadan ayrıldı': '{} kilépett a szobából',
  '{} bir video yükledi': '{} feltöltött egy videót',
  'bitti': 'vége',
  '{} sn': '{} mp',
  'Birlikte izle': 'Nézzétek együtt',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Tölts fel egy videót, hívd meg a barátaidat, és nézzétek egyszerre.',
  'Henüz bir odan ya da davetin yok.': 'Még nincs szobád és meghívód sem.',
  'Odaya katıl': 'Belépés szobába',
  'Oda kodu': 'Szobakód',
  'Katıl': 'Belépés',
  'Oda oluştur': 'Szoba létrehozása',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'A szobák 12 óra után maguktól bezárnak, a videó pedig törlődik.',
  'Odam': 'A szobám',
  '@{} odası': '@{} szobája',
  'Seni davet etti': 'Meghívott téged',
  '{} kişi': '{} fő',
  'Video yok': 'Nincs videó',
  '{} kaldı': '{} maradt',
  'Davet': 'Meghívó',
  '@{} davet edildi': '@{} meghívva',
  'Oda kodu kopyalandı': 'Szobakód másolva',
  'Odayı kapat': 'Szoba bezárása',
  'Odadan ayrıl': 'Kilépés a szobából',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'A szoba bezár, a videó törlődik. Ez nem vonható vissza.',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'Kilépsz a szobából. A kóddal vagy meghívóval visszatérhetsz.',
  'Ayrıl': 'Kilépés',
  'İzleme odası': 'Nézőszoba',
  'Odalar 12 saat sonra kendiliğinden kapanır.':
      'A szobák 12 óra után maguktól bezárnak.',
  '{} kişi · {} kaldı': '{} fő · {} maradt',
  'Davet et': 'Meghívás',
  'Bir video yükle, izlemeye başlayın': 'Tölts fel egy videót, és kezdjétek el',
  'Oda sahibi henüz video yüklemedi': 'A gazda még nem töltött fel videót',
  'Video yükle': 'Videó feltöltése',
  'En fazla {} GB · MP4 veya WebM': 'Legfeljebb {} GB · MP4 vagy WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB': 'Feltöltés folytatása · {}/{} MB',
  'Yükleniyor · {}/{} MB': 'Feltöltés · {}/{} MB',
  'Videoyu değiştir': 'Videó cseréje',
  'Oda sahibiyle eşleniyor': 'Szinkronizálás a gazdával',
  'Sohbet boş': 'A csevegés üres',
  'İzlerken buradan konuşabilirsiniz.': 'Itt beszélgethettek nézés közben.',
  'oda sahibi': 'gazda',
  'davet bekliyor': 'meghívó függőben',
  'çevrimdışı': 'offline',
  'Mesaj yaz...': 'Írj üzenetet...',
  'Oda kodunu kopyala': 'Szobakód másolása',
  'Oda kodu {} — kopyala': 'Szobakód: {} — másolás',
  'Arkadaşını davet et': 'Hívj meg egy barátot',
  'kullanıcı adı': 'felhasználónév',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'Csak azokat hívhatod meg, akik vissza is követnek.',
  ...
  'Parlaklık': 'Fényerő',
  'Kontrast': 'Kontraszt',
  'Doygunluk': 'Telítettség',
  'Pozlama': 'Expozíció',
  'Sıcaklık': 'Hőmérséklet',
  'Renk tonu': 'Színárnyalat',
  'Ton': 'Tónus',
  'Soluk': 'Fakítás',
  'Orijinal': 'Eredeti',
  'Sıcak': 'Meleg',
