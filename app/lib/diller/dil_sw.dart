...
const Map<String, String> cevirilerSw = {
  ...
  'Bu cihazdan yeni hesap açılamıyor': 'Huwezi kufungua akaunti kutoka kifaa hiki',
  'Geçerli e-posta, kullanıcı adı ve en az 6 karakter şifre gerekli': 'Unahitaji barua pepe halali, jina la mtumiaji na nenosiri la herufi 6+',
  'Geçerli e-posta ve en az 6 karakter şifre gerekli': 'Unahitaji barua pepe halali na nenosiri la herufi 6+',
  'Kullanıcı adı 3-20 karakter; küçük harf, rakam, nokta, tire ve alt çizgi kullanılabilir (başta/sonda nokta-tire olamaz)': 'Jina 3–20; herufi ndogo, tarakimu, nukta, kiungo, mstari wa chini (si kwenye ncha)',
  ...
  'İki adımlı doğrulama zaten bu durumda': 'Uthibitishaji wa hatua mbili tayari uko hivi',
  'Kod yanlış': 'Kodi si sahihi',
  'Kodun süresi doldu': 'Muda wa kodi umeisha',
  'Kullanıcının e-postası yok (misafir hesap)': 'Mtumiaji hana barua pepe (akaunti ya mgeni)',
  ...
  'Ad en fazla 60, açıklama 300 karakter olabilir': 'Jina si zaidi ya 60, maelezo 300',
  ...
  'Bölüm yorumu için sezon ve bolum birlikte gerekli': 'Maoni ya kipindi yanahitaji msimu na kipindi vyote',
  ...
  'Başlık ve metin gerekli (en az 2 karakter)': 'Kichwa na maandishi vinahitajika (herufi 2+)',
  ...
  'Mesaj bulunamadı veya düzenlenemez': 'Ujumbe haujapatikana au hauwezi kuhaririwa',
  'Yalnız sana gelen mesajı şikayet edebilirsin': 'Unaweza kuripoti tu ujumbe uliotumiwa kwako',
  'Sebep gerekli': 'Sababu inahitajika',
  'İtiraz edilecek aktif bir ceza yok': 'Hakuna adhabu hai ya kukata rufaa',
  'Zaten incelenmeyi bekleyen bir itirazın var': 'Tayari una rufaa inayosubiri ukaguzi',
  'Bu ceza için itirazın zaten incelendi': 'Rufaa ya adhabu hii tayari imekaguliwa',
  'Medya bağlantısının süresi dolmuş': 'Kiungo cha media kimeisha',
  'Bu medya için imzalı bağlantı gerekli': 'Faili hili linahitaji kiungo kilichosainiwa',
  'Arama hizmeti yeniden başlatılıyor, birazdan tekrar dene': 'Huduma ya simu inaanza tena; jaribu baadaye kidogo',
};
