...
const Map<String, String> cevirilerFil = {
  ...
  'Oturumunu açık tutmak ve dil/tema gibi tercihlerini hatırlamak için yerel depolama kullanırız. Sitenin hangi bölümlerinin ne kadar kullanıldığını toplu olarak görmek için web tarafında Google Analytics çalışır; bu araç tarayıcına kendi ölçüm çerezini yazar. Reklam veya reklam hedefleme çerezi yoktur.':
      'Gumagamit kami ng local storage para manatili kang naka-sign in at para matandaan ang mga kagustuhan gaya ng wika at tema. Sa web, tumatakbo ang Google Analytics para makita namin sa pinagsama-samang paraan kung aling mga bahagi ng site ang ginagamit; nagsusulat ito ng sarili nitong measurement cookie sa browser mo. Walang cookie para sa advertising o ad targeting.',
  ...
  "Dizi ve film bilgileri TMDB'den, izleme sağlayıcı bilgisi JustWatch'tan alınır. Push bildirimleri Google Firebase üzerinden iletilir, web trafiği ölçümü Google Analytics ile yapılır, site trafiği Cloudflare tarafından korunur. Bu hizmetler kendi gizlilik politikalarına tabidir.":
      'Ang impormasyon ng mga palabas at pelikula ay mula sa TMDB, at ang impormasyon ng mga streaming provider ay mula sa JustWatch. Ang mga push notification ay ipinapadala sa pamamagitan ng Google Firebase, ang web traffic ay sinusukat gamit ang Google Analytics, at ang trapiko ng site ay pinoprotektahan ng Cloudflare. Ang mga serbisyong ito ay napapailalim sa kanilang sariling mga patakaran sa privacy.',
  ...
  'Temizle': 'I-clear',
  'Oyuncu': 'Aktor',
  'Böyle bir oda yok': 'Walang ganoong room',
  'Bu oda kapandı': 'Sarado na ang room na ito',
  'Bu odaya girmek için davet ya da oda kodu gerekli':
      'Kailangan ng imbitasyon o room code para makapasok',
  'Oda dolu': 'Puno na ang room',
  'Bu odaya giremezsin': 'Hindi ka makakapasok sa room na ito',
  'Bu odanın üyesi değilsin': 'Hindi ka miyembro ng room na ito',
  'Bunu yalnız oda sahibi yapabilir':
      'Ang host lang ng room ang puwedeng gumawa nito',
  'Oda sahibi odayı kapatmalı': 'Ang host ang dapat magsara ng room',
  'Zaten açık bir odan var': 'May bukas ka nang room',
  'Oda kodu 6 karakter olmalı': 'Dapat 6 na karakter ang room code',
  'Misafir hesaplar izleme odası açamaz. Hesap oluşturursan açabilirsin.':
      'Hindi makakagawa ng room ang guest account. Gumawa ng account para makagawa.',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin':
      'Ang mga nagfo-follow back lang ang puwede mong i-invite',
  'Video en fazla {} GB olabilir': 'Hanggang {} GB lang ang video',
  'Yalnızca MP4 veya WebM izlenebilir': 'MP4 o WebM lang ang mapapanood',
  '{} odaya katıldı': 'Sumali si {} sa room',
  '{} odadan ayrıldı': 'Umalis si {} sa room',
  '{} bir video yükledi': 'Nag-upload si {} ng video',
  'bitti': 'tapos na',
  '{} sn': '{} seg',
  'Birlikte izle': 'Manood nang sabay',
  'Bir video yükle, arkadaşlarını davet et, aynı anda izleyin.':
      'Mag-upload ng video, i-invite ang mga kaibigan mo, at manood nang sabay.',
  'Henüz bir odan ya da davetin yok.': 'Wala ka pang room o imbitasyon.',
  'Odaya katıl': 'Sumali sa room',
  'Oda kodu': 'Room code',
  'Katıl': 'Sumali',
  'Oda oluştur': 'Gumawa ng room',
  'Odalar 12 saat sonra kendiliğinden kapanır ve video silinir.':
      'Kusang nagsasara ang mga room pagkatapos ng 12 oras at nabubura ang video.',
  'Odam': 'Room ko',
  '@{} odası': 'Room ni @{}',
  'Seni davet etti': 'Ini-invite ka',
  '{} kişi': '{} tao',
  'Video yok': 'Walang video',
  '{} kaldı': '{} na lang',
  'Davet': 'Imbitasyon',
  '@{} davet edildi': 'Na-invite si @{}',
  'Oda kodu kopyalandı': 'Nakopya ang room code',
  'Odayı kapat': 'Isara ang room',
  'Odadan ayrıl': 'Umalis sa room',
  'Oda kapanacak ve video silinecek. Bu geri alınamaz.':
      'Isasara ang room at buburahin ang video. Hindi na ito maibabalik.',
  'Odadan çıkacaksın. Kodla ya da davetle geri dönebilirsin.':
      'Aalis ka sa room. Puwede kang bumalik gamit ang code o imbitasyon.',
  'Ayrıl': 'Umalis',
  'İzleme odası': 'Panoorang room',
  'Odalar 12 saat sonra kendiliğinden kapanır.':
      'Kusang nagsasara ang mga room pagkatapos ng 12 oras.',
  '{} kişi · {} kaldı': '{} tao · {} na lang',
  'Davet et': 'Mag-invite',
  'Bir video yükle, izlemeye başlayın': 'Mag-upload ng video at simulan na',
  'Oda sahibi henüz video yüklemedi': 'Wala pang na-upload na video ang host',
  'Video yükle': 'Mag-upload ng video',
  'En fazla {} GB · MP4 veya WebM': 'Hanggang {} GB · MP4 o WebM',
  'Kaldığı yerden yükleniyor · {}/{} MB':
      'Ipinagpapatuloy ang upload · {}/{} MB',
  'Yükleniyor · {}/{} MB': 'Ina-upload · {}/{} MB',
  'Videoyu değiştir': 'Palitan ang video',
  'Oda sahibiyle eşleniyor': 'Sinusabayan ang host',
  'Sohbet boş': 'Walang laman ang chat',
  'İzlerken buradan konuşabilirsiniz.':
      'Puwede kayong mag-usap dito habang nanonood.',
  'oda sahibi': 'host',
  'davet bekliyor': 'naghihintay ng imbitasyon',
  'çevrimdışı': 'offline',
  'Mesaj yaz...': 'Magsulat ng mensahe...',
  'Oda kodunu kopyala': 'Kopyahin ang room code',
  'Oda kodu {} — kopyala': 'Room code {} — kopyahin',
  'Arkadaşını davet et': 'Mag-invite ng kaibigan',
  'kullanıcı adı': 'username',
  'Yalnız karşılıklı takipleştiğin kişileri davet edebilirsin.':
      'Ang mga nagfo-follow back lang ang puwede mong i-invite.',
  ...
  'Aşk': 'Pag-ibig',
  'Arkadaşlar': 'Mga kaibigan',
  'Gece': 'Gabi',
  'Okyanus': 'Karagatan',
  'Gün batımı': 'Paglubog ng araw',
  'Orman': 'Gubat',
  'Neon': 'Neon',
  'Temalar': 'Mga tema',
  'Renkler': 'Mga kulay',
