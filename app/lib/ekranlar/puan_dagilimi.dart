      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.bar_chart, color: DiziRenkler.sariMetin, size: 20),
            ...
            PuanDagilimiGrafigi(kovalar: kovalar, benimDbPuani: benimDbPuani),
          ],
        ),
      ),
    );
            ...
            SizedBox(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: benimKovam ? DiziRenkler.sariMetin : DiziRenkler.metin,
                ),
              ),
            ),
            if (benimKovam) ...[
