...
class _BildirimlerEkraniState extends State<BildirimlerEkrani> {
  ...
  /// Satırın ikonu + metni ORTAK KAYNAKTAN (`bildirim_gorunumu.dart`):
  /// aynı cümleleri uygulama içi anlık pencere de yazıyor (13 Eyl 2026).
  (IconData, String) _gorunum(Map<String, dynamic> b) => bildirimGorunumu(b);
