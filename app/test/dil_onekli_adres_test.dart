...
void main() {
  ...
  group('Ceviri.adresDiliKodu', () {
    test('dil öneki tanınır', () {
      expect(
        Ceviri.adresDiliKodu(
          Uri.parse('https://dizijpg.com/de/icerik/movie/559'),
        ),
        'de',
      );
      expect(
        Ceviri.adresDiliKodu(Uri.parse('https://dizijpg.com/ja/kisi/1')),
        'ja',
      );
    ...
    test('öneksiz adres ve `tr` öneki null (Türkçe KÖKTE yaşıyor)', () {
      expect(
        Ceviri.adresDiliKodu(Uri.parse('https://dizijpg.com/icerik/movie/559')),
        isNull,
      );
      // `/tr/...` diye bir kanonik YOK — sunucu tarafı da reddediyor.
      expect(
        Ceviri.adresDiliKodu(
          Uri.parse('https://dizijpg.com/tr/icerik/movie/1'),
        ),
        isNull,
      );
    ...
    test('DESTEKLENMEYEN kod dil öneki SAYILMAZ (rota parçası olabilir)', () {
      ...
      expect(
        Ceviri.adresDiliKodu(Uri.parse('https://dizijpg.com/zz/kisi/1')),
        isNull,
      );
      expect(
        Ceviri.adresDiliKodu(Uri.parse('https://dizijpg.com/kesfet')),
        isNull,
      );
      expect(
        Ceviri.adresDiliKodu(Uri.parse('https://dizijpg.com/gozat')),
        isNull,
      );
    });
  });
  ...
  group('baslangicRotasi dil önekini DÜŞÜRÜR', () {
    test('dil önekli derin bağlantı doğru rotaya açılır', () {
      expect(
        baslangicRotasi(Uri.parse('https://dizijpg.com/de/icerik/movie/559')),
        '/icerik/movie/559',
      );
      expect(
        baslangicRotasi(
      ...
      expect(
        baslangicRotasi(Uri.parse('https://dizijpg.com/ar/kisi/1')),
        '/kisi/1',
      );
    });
    ...
    test('öneksiz adresler DEĞİŞMEDİ (gerileme kilidi)', () {
      expect(
        baslangicRotasi(Uri.parse('https://dizijpg.com/icerik/movie/559')),
        '/icerik/movie/559',
      );
      expect(
      ...
      expect(
        baslangicRotasi(Uri.parse('https://dizijpg.com/zz/kisi/1')),
        '/zz/kisi/1',
      );
    });
  });
  ...
  group('Ceviri.yukle sırası: seçim > adres > cihaz', () {
    test('adresteki dil cihaz dilinin ÖNÜNE geçer', () async {
      ...
      await Ceviri.yukle(
        adres: Uri.parse('https://dizijpg.com/de/icerik/movie/1'),
      );
    ...
    test('adres yoksa cihaz dili okunur (eski davranış korunuyor)', () async {
      Ceviri.cihazDilleri = () => const [Locale('fr')];
      await Ceviri.yukle(
        adres: Uri.parse('https://dizijpg.com/icerik/movie/1'),
      );
