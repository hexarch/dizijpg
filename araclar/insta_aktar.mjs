...
// Sunucu sınırı 100MB (nginx 105m): Instagram videoları (40-70MB) ÖZGÜN
// kalitesinde yüklenir. Küçültme yalnızca sınırı da aşan devasa dosyalar
// için son çaredir (hedef bit hızıyla; CRF ile boyut öngörülemiyor).
